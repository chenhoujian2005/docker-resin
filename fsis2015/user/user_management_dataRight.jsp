...
<body>
<s:form action="user_management_dataRight" validate="false">
                                                        ...
                                                        <tr>
                                                            <td width="100%" valign="top">
                                                                <table class="displayTable">
                                                                    ...
                                                                    <c:forEach items="${requestScope.dsTitlesList}" var="thisDsTitle" varStatus="rowCounter">
                                                                            <c:if test="${rowCounter.count mod 3 eq 0}">
                                                                                <tr class="bgGreen1">
                                                                                    <td width="30%">
                                                                                        <input type="checkbox" name="dsRight"  id="${thisDsTitle.name}" value="${thisDsTitle.name}"/>${thisDsTitle.name}
                                                                                    </td>
                                                                            </c:if>
                                                                            <c:if test="${rowCounter.count mod 3 eq 1}">
                                                                                    <td width="30%">
                                                                                        <input type="checkbox" name="dsRight"  id="${thisDsTitle.name}"  value="${thisDsTitle.name}"/>${thisDsTitle.name}
                                                                                    </td>

                                                                            </c:if>
                                                                            <c:if test="${rowCounter.count mod 3 eq 2}">
                                                                                   <td width="30%">
                                                                                       <input type="checkbox" name="dsRight"  id="${thisDsTitle.name}"  value="${thisDsTitle.name}"/>${thisDsTitle.name}
                                                                                    </td>
                                                                            </tr>
