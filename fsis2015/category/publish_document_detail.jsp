...
<body>
<s:form action="publish_document_detail" enctype="multipart/form-data">
    <s:hidden name="reportTitleId" id="reportTitleId"/>
    <s:hidden name="reportNameHidden" id="reportNameHidden"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" align="center" style="height:100%">
                                <tr>
                                    <td width="15%" colspan="2"><b>Publish Document : Add/Edit </b></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <table width="100%" class="displayTable">
                                            <tr class="bgGreen2">
                                                <td width="20%" class="label">Name<span class="require_field">*</span> :
                                                </td>
                                                <td width="80%">
                                                    <s:textfield name="reportTitleName" id="reportTitleName"
...
<script type="text/javascript">
    ...
    function validateForm() {
        if (isEmptyById('reportTitleName')) {
