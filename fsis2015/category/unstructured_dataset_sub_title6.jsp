...
<body>
<s:form action="unstructured_dataset_sub_title6">
    <s:hidden name="id"/>
                                ...
                                <tr>
                                    <td style="height:100%">
                                        ...
                                        <table width=100%>
                                            <tr>
                                                <td>
                                                    <b>
                                                        <c:choose>
                                                            <c:when test="${empty requestScope.id}">Add Sub Title 6</c:when>
                                                            <c:when test="${not empty requestScope.id}">Edit Sub Title 6</c:when>
                                                        </c:choose>
                                                    </b>
                                                </td>
                                            </tr>
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="displayTable">
                                            ...
                                            <tr class="bgGreen1">
                                                <td width="25%" class="label">Sub Title6<span class="require_field">*</span> :</td>
                                                <td width="65%"><s:textfield name="subTitle6" id="subTitle6" cssStyle="width:100%" maxLength="256"/></td>
                                                <td width="10%">
