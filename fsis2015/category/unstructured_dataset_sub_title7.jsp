...
<body>
<s:form action="unstructured_dataset_sub_title7">
    <s:hidden name="id"/>
                                ...
                                <tr>
                                    <td style="height:100%">
                                        ...
                                        <table width=100%>
                                            <tr>
                                                <td>
                                                    <b>
                                                        <c:choose>
                                                            <c:when test="${empty requestScope.id}">Add Sub Title 7</c:when>
                                                            <c:when test="${not empty requestScope.id}">Edit Sub Title 7</c:when>
                                                        </c:choose>
                                                    </b>
                                                </td>
                                            </tr>
                                        ...
                                        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="displayTable">
                                            ...
                                            <tr class="bgGreen2">
                                                <td width="25%" class="label">Sub Title7<span class="require_field">*</span> :</td>
                                                <td width="65%"><s:textfield name="subTitle7" id="subTitle7" cssStyle="width:100%" maxLength="256"/></td>
                                                <td width="10%">
...
<script type="text/javascript">
    ...
    if(thisForm.id.value != ''){
        ...
        thisForm.subTitle2.disabled = true;
        thisForm.subTitle3.disabled = true;
        thisForm.subTitle4.disabled = true;
        thisForm.subTitle5.disabled = true;
        thisForm.subTitle6.disabled = true;
    }
</script>
</body>
</html>
