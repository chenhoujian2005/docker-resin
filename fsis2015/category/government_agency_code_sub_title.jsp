...
<script type="text/javascript">
    function validateForm(){
        ...
        if(trim(thisForm.subTitleCode.value) == ''){
            alert('กรุณาระบุรหัสหน่วยงาน (ย่อย)');
            thisForm.subTitleCode.focus();
            return false;
        }
        if(trim(thisForm.subTitleName.value) == ''){
            alert('กรุณาระบุส่วนราชการและรัฐวิสาหกิจ (ย่อย)');
            thisForm.subTitleName.focus();
            return false;
        }
        return true;
    }
...
<body>
<s:form action="government_agency_code_sub_title">
<s:hidden name="id"/>
                                    ...
                                    <td style="height:100%">
                                        ...
                                        <table width=100%>
                                            <tr>
                                                <td>
                                                    <b>
                                                        <c:if test="${empty requestScope.id}">Add Goverment Agency Code Sub Title</c:if>
                                                        <c:if test="${not empty requestScope.id}">Edit Goverment Agency Code Sub Title</c:if>
                                                    </b>
                                                </td>
                                            </tr>
                                        </table>
                                        <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" class="displayTable">
                                            <tr class="bgGreen2">
                                                ...
                                                <td colspan="2">
                                                    <s:select list="governmentTitleList" name="titleCode" listKey="code" listValue="name"/>
                                                </td>
                                            </tr>
                                            <tr class="bgGreen1">
                                                <td width="25%" class="label">รหัสหน่วยงาน (ย่อย)<span class="require_field">*</span> :</td>
                                                <td width="65%">
                                                    <s:textfield name="subTitleCode" id="subTitleCode" cssStyle="width:100%" maxLength="10"/>
                                                </td>
                                                <%--<td width="10%">--%>
                                            ...
                                            <tr class="bgGreen1">
                                                <td class="label">ส่วนราชการและรัฐวิสาหกิจ (ย่อย) <span class="require_field">*</span> :</td>
                                                <td colspan="2">
                                                    <s:textfield name="subTitleName" id="subTitleName" cssStyle="width:100%" maxLength="200"/>
                                                </td>
                                            </tr>
                                            <tr class="bgGreen2">
...
//        thisForm.titleCode.disabled = true;
//        thisForm.subTitleCode.disabled = true;
    }
</script>
</body>
</html>
