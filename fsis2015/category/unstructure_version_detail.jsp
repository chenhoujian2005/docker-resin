...
<head>
 ...
 <body>
<s:form action="unstructure_version_detail">
<s:hidden id="unstructureVersionId" name="unstructureVersionId"/>
<s:hidden id="versionHidden" name="versionHidden"/>
<s:hidden id="descriptionHidden" name="descriptionHidden"/>
<s:hidden id="effectiveDateHidden" name="effectiveDateHidden"/>
                ...
                <tr>
                    ...
                    <td>
                        <table width="100%" border="0" align="center" style="height:100%">
                            <tr>
                                <td width="35%">
                                    <b>Unstructured Version Detail</b>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <table width="100%" class="displayTable">
                                        ...
                                        <tr class="bgGreen1">
                                          ...
                                          <tr class="bgGreen2">
                                             <td class="label">Effective Date <span class="require_field">*</span>:</td>
                                             <td>
