                                ...
                                <tr>
                                    ...
                                    <td width="100%">
                                        ...
                                        <table class="displayTable" width="1200px">
                                            ...
                                            <xsl:for-each
                                                    select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right"
                                                            ...
                                                            <xsl:if test="not(CcfRate='')">
                                                                <xsl:value-of
                                                                        select="format-number(CcfRate,'###,###,###,##0.00')"/>
                                                            </xsl:if>
                                                        </td>
                                                        <td class="labelXsl" align="right"
                                                            style="mso-number-format:'\#\,\#\#0\.00'">
                                                            <xsl:if test="not(RwaRate='')">
                                                                <xsl:value-of
                                                                        select="format-number(RwaRate,'###,###,###,##0.00')"/>
                                                            </xsl:if>
                                                        </td>
                                                        <td class="labelXsl" align="center">
                                                            <xsl:value-of select="InvolvedPartyType"/>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018004 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018004,'###,##0.00')"/>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018027 != ''">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" class="labelXsl">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018027,'###,##0.00')"/>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018032 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018032,'###,##0.00')"/>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018298 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018298,'###,##0.00')"/>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018299 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018299,'###,##0.00')"/>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018053 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018053,'###,##0.00')"/>
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018054 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018054,'###,##0.00')"/>
                                            ...
                                            <xsl:for-each
                                                ...
                                                <xsl:if test="ArrangementType = '018072'">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl  subTwo" align="left">
                                                            การค้ำประกันการจำหน่ายตราสาร หรือ หลักทรัพย์แบบFirm
                                                            Underwriting
                                                        </td>
                                                        <td class="labelXsl" align="right"
                                                            style="mso-number-format:'\#\,\#\#0\.00'">
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018080 != ''">
                                                    <tr>
                                                        ...
                                                        <td align="right" class="labelXsl">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018080,'###,##0.00')"/>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
