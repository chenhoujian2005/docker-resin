                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="95%">
										...
										<table class="displayTable" width="15%">
											<tr>
										...
										<table width="4900px" class="displayTable" border="0">
											<tr class="headTableXsl">
												<td colspan="48" align="center">Load Arrangement</td>
											</tr>
											<tr class="headTableXsl">
												<td align="center" width="100px" rowspan="2">Branch Number</td>
                                                <td align="center" width="100px" rowspan="2">Branch Name</td>
												...
												<td align="center" colspan="6">Collateral Group Info</td>
											</tr>
											<tr class="headTableXsl" >
												<td width="100px">Loan Type</td>
												<td width="100px">Movement Type</td>
												<td width="200px">Movement Type Description</td>
												<td width="100px">Asset Classification Type</td>
												<td width="200px">Asset Classification Reason</td>
												<td width="100px">Credit Type</td>
												<td width="100px">Primary Involved Party Id</td>
												<td width="100px">Unique Id Type</td>
												<td width="100px">Risk And Reward Involved Party Id</td>
												<td width="100px">Risk And Reward Unique Id Type</td>
												<td width="100px">Review Flag</td>
												<td width="100px">Arrangement Contract Date</td>
												<td width="100px">Arrangement Purpose Code</td>
												<td width="200px">Arrangement Purpose Code Description</td>
												<td width="100px">Lending Business Type</td>
												<td width="100px">Lending Business Type Description</td>
												<td width="100px">Effective Date</td>
												<td width="100px">Maturity Date</td>
												<td width="100px">Description </td>
												<td width="100px">Operation Progress</td>
												<td width="100px">Minimum Interest Rate</td>
												<td width="100px">Maximum Interest Rate</td>
												<td width="100px">Contract Currency Id</td>
												<td width="100px">Country Id To Invest </td>
												<td width="100px">Contract Amount </td>
												
												<td width="100px">TDR Method Type</td>
												<td width="200px">TDR Type</td>
												<td width="100px">Number of Re-entry</td>
												<td width="100px">Principal Hair-Cut Amount</td>
												<td width="100px">Interest Hair-Cut Amount</td>
												<td width="100px">VAT Waived Amount</td>
												<td width="100px">Business Tax Waived Amount</td>
												<td width="100px">Other Tax Waived Amount</td>
												
												<td width="100px">Other Arrangement Number</td>
												<td width="100px">AR AR Relationship Type</td>
												
												<td width="100px">Related Involved Party Id</td>
												<td width="100px">Unique Id Type</td>
												<td width="100px">IP AR Relationship Type</td>
												<td width="100px">Outstanding Amount</td>
												<td width="100px">Accrued Interest Amount</td>
												<td width="100px">Suspended Interest Amount</td>
												<td width="100px">Cash Flow Value Amount</td>
												
												<td width="200px">Collateral Type</td>
												<td width="100px">Collateral Value Amount</td>
												<td width="100px">Collateral Pledged Amount</td>
											</tr>
											<xsl:for-each select="DS_LAR/DS_LAR_Content/ContentRecordGroup">
												<tr>
													...
													<td class="labelXsl">
														<xsl:value-of select="RiskAndRewardInvolvedPartyId"/>
													</td>
													<td class="labelXsl">
														<xsl:value-of select="RiskAndRewardUniqueIdType"/>
													</td>
													<td class="labelXsl">
							                        ...
							                        <xsl:if test="$MinimumInterestRate =''">
							                            <td class="labelXsl" align="right">0.00000</td>
							                        </xsl:if>
													...
													<td class="labelXsl">
														<xsl:value-of select="CountryIdToInvest"/>
													</td>
							                        ...
							                        <xsl:if test="$ContractAmount =''">
							                            <td class="labelXsl" align="right">0.00</td>
							                        </xsl:if>
