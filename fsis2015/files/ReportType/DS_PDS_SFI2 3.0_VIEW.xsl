                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="43"><img src="../../images/table001.gif" width="43" height="43"/>
                                    </td>
                                    <td background="../../images/table002.gif">
                                        <img src="../../images/table002.gif" width="362" height="43"/>
                                    </td>
                                    <td width="173">
                                        <img src="../../images/table003.gif" width="173" height="43"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
						    ...
						    <button onclick="window.print()">Print</button>
                                        ...
                                        <table class="displayTable" width="50%">
                                            <tr>
                                                ...
                                                <td width="15%" colspan="3"><xsl:value-of select="DS_PDS/CommonHeader/OrganizationId"/></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3"><xsl:value-of select="DS_PDS/@name"/></td>
                                            </tr>
                                            <!--<tr>-->
                                                <!--<td class="bgGreen"><xsl:value-of select="$DataSetPeriodMonth"/></td>-->
                                                <!--<td colspan="3"><xsl:value-of select="DS_PDS/DS_PDS_Header/DataSetPeriodMonth"/></td>-->
                                            <!--</tr>-->
                                            <tr>
                                                <td class="bgGreen"> </td>
