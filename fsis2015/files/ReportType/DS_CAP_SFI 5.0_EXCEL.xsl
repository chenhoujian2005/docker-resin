                ...
                <table class="displayTable" width="100%" border="1">
                  ...
                  <tr>
                    ...
                    <td width="60%" class="labelXsl">
                      <xsl:value-of select="$name940001"/>
                    </td>
                    <td class="labelXsl" align="right">
                      <!--<span style="color:#1500d4">-->
                        <!--<xsl:value-of select="format-number($TotalAmountPerBook940001,'###,###,###,###,###,###,##0.00')"/>-->
                      <!--</span>-->
                    </td>
                    <td class="labelXsl" align="right">
                      <!--<span style="color:#1500d4">-->
                        <!--<xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940001,'###,###,###,###,###,###,##0.00')"/>-->
                      <!--</span>-->
                    </td>
                    <td class="labelXsl" align="right">
                      <!--<span style="color:#1500d4">-->
                        <!--<xsl:value-of select="format-number($TotalNetCapitalFundAmount940001,'###,###,###,###,###,###,##0.00')"/>-->
                      <!--</span>-->
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td width="60%" class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940002"/>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940002,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940002,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940002,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940003"/>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940003,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940003,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940003,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940004">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940004,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940004,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940004,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940005">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940005,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940005,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940005,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940006">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940006,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940006,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940006,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940007,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940007,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940007,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940008">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940008,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940008,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940008,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940008">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940009,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940009,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940009,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940010">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940010,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940010,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940010,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940010">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940011,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940011,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940011,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940012">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940012,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940012,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940012,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940038"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940038">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940038,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940038,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940038,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940062"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940062">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940062,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940062,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940062,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940013">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940013,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940013,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940013,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940014,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940014,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940014,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940015">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940015,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940015,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940015,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940016">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940016,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940016,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940016,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940063"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940063">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940063,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940063,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940063,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940091"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940091">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940091,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940091,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940091,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940064"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940064">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940064,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940064,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940064,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940065"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940065">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940065,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940065,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940065,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940017">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940017,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940017,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940017,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940018,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940018,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940018,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940019,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940019,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940019,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  ...
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940020">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940020,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940020,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940020,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940021">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940021,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940021,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940021,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940022">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940022,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940022,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940022,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940066"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940066">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940066,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940066,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940066,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940023">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940023,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940023,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940023,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940024">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940024,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940024,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940024,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940025">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940025,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940025,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940025,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940026">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940026,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940026,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940026,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940067"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940067">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940067,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940067,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940067,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940068"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940068">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940068,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940068,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940068,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940027">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940027,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940027,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940027,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940092"/>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940092,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940092,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940092,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940093"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940093">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940093,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940093,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940093,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940094"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940094">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940094,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940094,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940094,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940028,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940028,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940028,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940029">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940029,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940029,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940029,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940030,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940030,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940030,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940032,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940032,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940032,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="subThree  labelXsl">
                      <xsl:value-of select="$name940070"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940070">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940070,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940070,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940070,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subThree  labelXsl">
                      <xsl:value-of select="$name940071"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940071">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940071,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940071,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940071,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940033">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940033,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                  ...
                  <tr>
                    ...
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940034,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940034,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940034,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940035">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940035,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940035,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940035,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940073"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940073">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940073,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940073,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940073,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940036">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940036,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940036,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940036,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940074"/>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940074,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940074,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940074,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940075"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940075">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940075,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940075,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940075,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subTwo  labelXsl">
                      <xsl:value-of select="$name940076"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940076">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940076,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940076,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940076,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="labelXsl">
                      <xsl:value-of select="$name940079"/>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940079,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940079,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940079,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940097"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940097">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940097,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940097,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940097,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940098"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940098">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940098,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940098,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940098,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940080"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940080">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940080,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940080,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940080,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940081"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940081">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940081,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940081,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940081,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940082"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940082">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940082,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940082,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940082,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940083"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940083">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940083,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940083,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940083,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940099"/>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalAmountPerBook940099,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940099,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                    <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                      <span style="color:#1500d4">
                        <xsl:value-of select="format-number($TotalNetCapitalFundAmount940099,'###,###,###,###,###,###,##0.00')"/>
                      </span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940100"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940100">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940100,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940100,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940100,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="subOne  labelXsl">
                      <xsl:value-of select="$name940101"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940101">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940101,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940101,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940101,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940084"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940084">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940084,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940084,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940084,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940085"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940085">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940085,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940085,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940085,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940102"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940102">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940102,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940102,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940102,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940086"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940086">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940086,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940086,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940086,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
                  <tr>
                    ...
                    <td class="paddingSub  labelXsl">
                      <xsl:value-of select="$name940087"/>
                    </td>
                    <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940087">
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($AmountPerBook940087,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($ApplicableCapitalFundAmount940087,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                      <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                        <span style="color:#1500d4">
                          <xsl:value-of select="format-number($NetCapitalFundAmount940087,'###,###,###,###,###,###,##0.00')"/>
                        </span>
                      </td>
                    </xsl:for-each>
                  </tr>
