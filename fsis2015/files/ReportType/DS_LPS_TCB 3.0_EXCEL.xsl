                    ...
                    <!--xsl:for-each select="DS_LPS/DS_LPS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails"-->
                        <xsl:if test="TotalOutstandingAmount018024 != ''">
                            <tr>
                                ...
                                <td align="right"  style="mso-number-format:'\#\,\#\#0\.00'" class="labelXsl">
                                    <span style="color:#1500d4">
                                        <!--sl:value-of select="format-number(TotalOutstandingAmount018024,'###,###')"/-->
										 <xsl:value-of select="format-number(TotalOutstandingAmount018024,'###,##0.00')"/>
                                    </span>
                                </td>
                            </tr>
                        </xsl:if>
                                ...
                                <td align="right"  style="mso-number-format:'\#\,\#\#0\.00'" class="labelXsl">
                                    <span style="color:#1500d4">
                                        <!--xsl:value-of select="format-number(TotalOutstandingAmount018027,'###,###')"/-->
										 <xsl:value-of select="format-number(TotalOutstandingAmount018027,'###,##0.00')"/>
                                    </span>
                                </td>
                            </tr>
                        </xsl:if>
