                                ...
                                <tr>
                                    ...
                                    <td width="95%">
                                        ...
                                        <table width="100%" class="displayTable" border="0">
                                            ...
                                            <xsl:for-each
                                                    select="DS_LPS/DS_LPS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                            ...
                                            <tr>
                                                ...
                                                <td class="labelXsl" align="right" >
                                                    <span style="color:#1500d4" >
                                                        <xsl:value-of select="format-number(DS_LPS/TotalOutstandingAmount018004,'###,##0.00')"/>
                                                    </span>
                                                </td>
                                            </tr>
                                            <xsl:for-each
                                            ...
                                            <xsl:for-each select="DS_LPS">
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018024 != ''">
                                                    <tr>
                                                        <td class="labelXsl" align="center">
                                                            018024
                                                        </td>
                                                        ...
                                                        <td align="right" class="labelXsl">
                                                            <span style="color:#1500d4">
                                                                <!--xsl:value-of select="format-number(TotalOutstandingAmount018024,'###,###')"/-->
                                                                <xsl:value-of
                                                                        select="format-number(TotalOutstandingAmount018024,'###,##0.00')"/>
                                            ...
                                            <xsl:for-each select="DS_LPS">
                                                ...
                                                <xsl:if test="TotalOutstandingAmount018027 != ''">
                                                    <tr>
                                                        ...
                                                        <td align="center" class="labelXsl">
                                                            <span style="color:#1500d4">
                                                                <!--xsl:value-of select="format-number(NumberOfAccounts,'###,###')"/--></span>
                                                        </td>
                                                        <td align="right" class="labelXsl">
                                                            <span style="color:#1500d4">
                                                                <!--xsl:value-of select="format-number(TotalOutstandingAmount018027,'###,###')"/-->
                                                                <xsl:value-of
