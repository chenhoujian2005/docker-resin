                            ...
                            <tr>
                                ...
                                <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                                    <span style="color:#1500d4">
                                        <xsl:value-of select="MovementAmount018001"/>
                                    </span>
                                </td>
                            </tr>
                        </xsl:if>
                    ...
                    <xsl:for-each select="DS_AMS">
                        <xsl:if test="MovementAmount018002 != ''">
                            <tr>
                                ...
                                <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                                    <span style="color:#1500d4">
                                        <xsl:value-of select="MovementAmount018002"/>
                                    </span>
                                </td>
                            </tr>
                        </xsl:if>
                        ...
                        <xsl:if test="ArrangementType = '018003'">
                            <tr>
                                ...
                                <td align="right" class="labelXsl" style="mso-number-format:'\#\,\#\#0\.00'">
                                    <span style="color:#1500d4">
                                        <xsl:value-of select="MovementAmount"/>
                                    </span>
                                </td>
                            </tr>
                        </xsl:if>
                        ...
                        <xsl:if test="MovementAmount018032 != '' ">
                            <tr>
                                ...
                                <td class="labelXsl" align="right" style="mso-number-format:'\#\,\#\#0\.00'">
                                    <span style="color:#1500d4">
                                        <span style="color:#1500d4">
                                            <xsl:value-of select="MovementAmount018032"/>
                                        </span>
                                    </span>
                                </td>
                            </tr>
