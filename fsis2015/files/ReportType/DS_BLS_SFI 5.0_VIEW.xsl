    ...
    <xsl:template match="/">
        <html>
            ...
            <!--rowUp-->
				...
				<xsl:variable name="BalanceSheetAmount950614"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950614/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				<xsl:variable name="BalanceSheetAmount950615"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950615/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
			    <xsl:variable name="TotalBalanceSheetAmount950286"><xsl:value-of select="$BalanceSheetAmount950614 + $BalanceSheetAmount950615"/></xsl:variable>
				...
				<xsl:variable name="TotalBalanceSheetAmount950277"><xsl:value-of select="$TotalBalanceSheetAmount950278 + $TotalBalanceSheetAmount950281 + $BalanceSheetAmount950284 + $BalanceSheetAmount950285 - $TotalBalanceSheetAmount950286 - $BalanceSheetAmount950287"/></xsl:variable>
                <!--3.-->
				...
				<xsl:variable name="BalanceSheetAmount950623"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950623/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				<xsl:variable name="BalanceSheetAmount950624"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950624/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				<xsl:variable name="BalanceSheetAmount950625"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950625/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				
				
				<xsl:variable name="BalanceSheetAmount950618"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950618/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				<xsl:variable name="BalanceSheetAmount950619"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950619/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				
				<xsl:variable name="TotalBalanceSheetAmount950617"><xsl:value-of select="$BalanceSheetAmount950618 + $BalanceSheetAmount950619"/></xsl:variable>
				<xsl:variable name="BalanceSheetAmount950621"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950621/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				<xsl:variable name="BalanceSheetAmount950622"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950622/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
				
				<xsl:variable name="TotalBalanceSheetAmount950620"><xsl:value-of select="$BalanceSheetAmount950621 + $BalanceSheetAmount950622"/></xsl:variable>
				
				<!--<xsl:variable name="TotalBalanceSheetAmount950616"><xsl:value-of select="$TotalBalanceSheetAmount950617 + $TotalBalanceSheetAmount950620 + $BalanceSheetAmount950623 + $BalanceSheetAmount950624 + $BalanceSheetAmount950625"/></xsl:variable>-->
            <xsl:variable name="TotalBalanceSheetAmount950616"><xsl:value-of select="$BalanceSheetAmount950618 + $BalanceSheetAmount950619 + $BalanceSheetAmount950621 + $BalanceSheetAmount950622 - $BalanceSheetAmount950623 - $BalanceSheetAmount950624 - $BalanceSheetAmount950625"/></xsl:variable>
							    ...
							    <td width="20%" hight="15px" align="center">
                                        ...
                                        <table class="displayTable" width="100%" border="0">
                                            ...
                                            <tr>
											 ...
											 <tr>
                                                <td align="center" class="labelXsl">950614</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950614,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
											 <tr>
                                                <td align="center" class="labelXsl">950615</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950615,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
											...
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950618/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950618,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950619/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950619,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
											...
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950621/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950621,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950622/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950622,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950623/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950623,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950624/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950624,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
											<tr>
                                                ...
                                                <xsl:for-each
                                                        select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950625/BalanceSheetItemInfo">
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950625,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
