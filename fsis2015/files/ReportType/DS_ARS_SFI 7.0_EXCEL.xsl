        ...
        <html>
            ...
            <body>
                                        ...
                                        <table class="displayTable" width="50%" border="1">
                                            ...
                                            <tr>
                                                <td class="bgGreen"></td>
						<td class="bgGreen" align="center" colspan="5">Day</td>
                                            ...
                                            <tr>
                                                <td class="bgGreen">Data Set Date :</td>
                                                        <xsl:variable name="month"><xsl:value-of select="substring-after(substring-before(DataSetDate,'-'),'-')"/></xsl:variable>
                                                            <xsl:for-each select="DS_ARS/CommonHeader">
							    <td width="20%" hight="15px" align="center" colspan="5">
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018023 != ''">
                                              <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018023,'###,##0.00')"/>
...
<!--<xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">-->
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018027 != ''">
                                            <!--<xsl:if test="ArrangementType = '018027'">-->
                                                 ...
                                                 <td  align="right" class="labelXsl">
                                                   <span style="color:#1500d4"><xsl:value-of select="format-number(TotalOutstandingAmount018027,'###,##0.00')"/></span>
                                                </td>
                                                </tr>
                                                </xsl:if>
                                            </xsl:for-each>
...
<xsl:for-each select="DS_ARS">
											...
											<xsl:if test="TotalOutstandingAmount018006 != ''">
                                                 ...
                                                 <td  align="right" class="labelXsl">
                                                   <span style="color:#1500d4"><xsl:value-of select="format-number(TotalOutstandingAmount018006,'###,##0.00')"/></span>
                                                </td>
                                                </tr>
                                                </xsl:if>
                                            </xsl:for-each>
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018032 != ''">
                                              <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018032,'###,##0.00')"/>
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018298 != ''">
                                              <tr>
                                                    <td class="labelXsl" align="center">
                                                         018298
                                                    </td>                                                    
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018298,'###,##0.00')"/>
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018299 != ''">
                                              <tr>
                                                    <td class="labelXsl" align="center">
                                                         018299
                                                    </td>                                                    
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018299,'###,##0.00')"/>
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018035 != ''">
                                              <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018035,'###,##0.00')"/>
											...
											<xsl:if test="TotalOutstandingAmount018037 != ''">
                                              <tr>
                                                    <td class="labelXsl" align="center">
                                                     ...
                                                     <td  class="labelXsl" align="left">
                                                         &#160;&#160;Deposit from Customer (เงินรับฝาก)
                                                    </td>
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018053 != ''">
                                              <tr>
                                                    <td class="labelXsl" align="center">
                                                         018053
                                                    </td>                                                    
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018053,'###,##0.00')"/>
...
<xsl:for-each select="DS_ARS">
											<xsl:if test="TotalOutstandingAmount018054 != ''">
                                              <tr>
                                                    <td class="labelXsl" align="center">
                                                         018054
                                                    </td>                                                    
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018054,'###,##0.00')"/>
                                            ...
                                            <xsl:if test="ArrangementType = '018072'">
                                                  <tr>
                                                    <td class="labelXsl" align="center">
                                                     ...
                                                     <td  class="labelXsl SubTwo" align="left">
					                                   &#160;&#160;&#160;&#160;การค้ำประกันการจำหน่ายตราสาร หรือ หลักทรัพย์แบบFirm Underwriting
                                                    </td>
...
<!-- [parent] -->
<xsl:for-each select="DS_ARS">
                                            <xsl:if test="TotalOutstandingAmount018080 != ''">
                                                  <tr>
                                                    <td class="labelXsl" align="center">
                                                         018080
                                                    </td>                                                     
                                                 ...
                                                 <td  align="right" class="labelXsl">
                                                   <span style="color:#1500d4"><xsl:value-of select="format-number(TotalOutstandingAmount018080,'###,##0.00')"/></span>
                                                </td>
                                                </tr>
                                                </xsl:if>
                                            </xsl:for-each>
...
<xsl:for-each select="DS_ARS">
                                            <xsl:if test="TotalOutstandingAmount018081 != ''">
                                                 ...
                                                 <td  align="right" class="labelXsl">
                                                   <span style="color:#1500d4"><xsl:value-of select="format-number(TotalOutstandingAmount018081,'###,##0.00')"/></span>
                                                </td>
                                                </tr>
                                                </xsl:if>
                                            </xsl:for-each>
                                            ...
                                            <xsl:if test="ArrangementType = '018095'">
                                                  <tr>
                                                    <td class="labelXsl" align="center">
                                                     ...
                                                     <td colspan="5" class="labelXsl SubTwo" align="left">
											...
											<xsl:if test="TotalOutstandingAmount018096 != ''">
                                              <tr>
                                                    <td class="labelXsl" align="center">
                                                     ...
                                                     <td colspan="5" class="labelXsl" align="left">
