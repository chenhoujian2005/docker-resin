                                        ...
                                        <table class="displayTable" width="100%" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                             <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950264,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950900,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950240,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950251,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
