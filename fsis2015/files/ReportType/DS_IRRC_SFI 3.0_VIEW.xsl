...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="name990037">				รายการระหว่างกันที่สาขาเป็นเจ้าหน้ีสำนักงานใหญ่และสาขาอื่นที่เป็นนิติบุคคลเดียวกันที่อ่อนไหวต่ออัตราดอกเบี้ย	      </xsl:variable>
