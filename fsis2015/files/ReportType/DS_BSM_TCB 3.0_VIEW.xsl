                                    ...
                                    <td width="95%">
                                        ...
                                        <table class="displayTable" width="100%" border="0">
                                            <tr class="headTableXsl">
                                                <td align="center" colspan="2" rowspan="2" width="10%">Branch Summary Item</td>
                                                <td colspan="5" align="center" width="50%">เงินรับฝาก
                                                    (หักส่วนลดจ่ายรอตัดบัญชี)
                                                </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073002 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073002,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073003 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073003,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073004 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073004,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073005 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073005,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073006 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073006,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073008 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073008,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073009 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073009,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073010 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073010,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073012 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073012,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td width="10%" align="right" class="labelXsl">
                                                        <xsl:if test="not(BranchSummaryItem073011 ='')">
                                                            <xsl:value-of
                                                                    select="format-number(BranchSummaryItem073011,'###,###,###,###,###,###,###,###,##0.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                </tr>
                                            </xsl:for-each>
