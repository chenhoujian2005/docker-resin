    ...
    <html>
      ...
      <xsl:variable name="name920420">	            22.2.2.2 อื่น ๆ	</xsl:variable>
        ...
        <xsl:variable name="Amount920252">
            <xsl:value-of select="DS_PNL/DS_PNL_Content/ContentRecordGroup/ProfitAndLossItem920252/Amount"/></xsl:variable>
        ...
        <xsl:variable name="TotalAmount920255"><xsl:value-of select="$Amount920421 + $Amount920422 "/></xsl:variable>
        <xsl:variable name="TotalAmount920258"><xsl:value-of select="$Amount920259 + $Amount920260 + $Amount920261"/></xsl:variable>
        <xsl:variable name="TotalAmount920253"><xsl:value-of select="$Amount920254 + $TotalAmount920255 + $Amount920256 "/></xsl:variable>
        <xsl:variable name="TotalAmount920251"><xsl:value-of select="$Amount920252 + $TotalAmount920253 + $Amount920257 + $TotalAmount920258 + $Amount920262 "/></xsl:variable>
        ...
        <xsl:variable name="Amount920290">
            <xsl:value-of select="DS_PNL/DS_PNL_Content/ContentRecordGroup/ProfitAndLossItem920290/Amount"/></xsl:variable>
        ...
        <xsl:variable name="Amount920298">
            <xsl:value-of select="DS_PNL/DS_PNL_Content/ContentRecordGroup/ProfitAndLossItem920298/Amount"/></xsl:variable>
        ...
        <xsl:variable name="TotalAmount920287">
            <xsl:value-of select="$Amount920288 + $Amount920289 + $Amount920290 + $Amount920291"/></xsl:variable>
        <xsl:variable name="TotalAmount920276">
            <xsl:value-of select="$Amount920277 + $TotalAmount920278 + $TotalAmount920283 + $TotalAmount920287 + $Amount920292 + $Amount920293 +$Amount920294 + $Amount920295 + $Amount920296 +$Amount920297 + $Amount920298 + $Amount920299 "/>
        </xsl:variable>
      ...
      <body>
                    ...
                    <table width="100%" class="displayTable" border="1">
                      ...
                      <tr>
                        ...
                        <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                                <xsl:if test="$TotalAmount920251 != 'NaN'">
                      ...
                      <tr>
                        <td   width="10%" align="center">920383 </td>
                        <td width="80%"  align="left" class="paddingSub labelXsl">
                      ...
                      <tr>
                        <td   width="10%" align="center">920384 </td>
                        <td width="80%"  align="left" class="paddingSub labelXsl">
