...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <html>
	  ...
	  <xsl:variable name="name920456">	รายได้ดอกเบี้ยจากลูกหนี้ธุรกรรมนโยบายรัฐ [เฉพาะ SFIs]	</xsl:variable>
	 ...
	 <!-- -->
      ...
      <!-- 1 -->
        ...
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920430/Amount"/></xsl:variable>
		<xsl:variable name="Amount920431">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920431/Amount"/></xsl:variable>
		<xsl:variable name="Amount920432">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920432/Amount"/></xsl:variable>
		<xsl:variable name="Amount920433">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920433/Amount"/></xsl:variable>
		<xsl:variable name="Amount920434">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920434/Amount"/></xsl:variable>
		<xsl:variable name="Amount920435">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920435/Amount"/></xsl:variable>
	 	<xsl:variable name="Amount920436">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920436/Amount"/></xsl:variable>
      ...
      <xsl:variable name="Amount920254">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920254/Amount"/></xsl:variable>
      <xsl:variable name="Amount920421">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920421/Amount"/></xsl:variable>
      <xsl:variable name="Amount920422">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920422/Amount"/></xsl:variable>
      <xsl:variable name="Amount920256">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920256/Amount"/></xsl:variable>
      <xsl:variable name="Amount920257">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920257/Amount"/></xsl:variable>
      <xsl:variable name="Amount920259">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920259/Amount"/></xsl:variable>
      <xsl:variable name="Amount920260">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920260/Amount"/></xsl:variable>
      <xsl:variable name="Amount920261">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920261/Amount"/></xsl:variable>
      <xsl:variable name="Amount920262">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920262/Amount"/></xsl:variable>
      ...
      <xsl:variable name="Amount920264">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920264/Amount"/></xsl:variable>
      <xsl:variable name="Amount920266">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920266/Amount"/></xsl:variable>
      <xsl:variable name="Amount920267">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920267/Amount"/></xsl:variable>
      <xsl:variable name="Amount920268">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920268/Amount"/></xsl:variable>
      <xsl:variable name="Amount920270">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920270/Amount"/></xsl:variable>
      <xsl:variable name="Amount920271">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920271/Amount"/></xsl:variable>
      <xsl:variable name="Amount920272">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920272/Amount"/></xsl:variable>
      <xsl:variable name="Amount920273">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920273/Amount"/></xsl:variable>
      <xsl:variable name="Amount920274">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920274/Amount"/></xsl:variable>
      <xsl:variable name="Amount920275">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920275/Amount"/></xsl:variable>
      ...
      <xsl:variable name="Amount920277">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920277/Amount"/></xsl:variable>
      <xsl:variable name="Amount920279">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920279/Amount"/></xsl:variable>
      <xsl:variable name="Amount920280">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920280/Amount"/></xsl:variable>
      <xsl:variable name="Amount920281">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920281/Amount"/></xsl:variable>
      <xsl:variable name="Amount920282">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920282/Amount"/></xsl:variable>
      <xsl:variable name="Amount920284">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920284/Amount"/></xsl:variable>
      <xsl:variable name="Amount920285">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920285/Amount"/></xsl:variable>
      <xsl:variable name="Amount920286">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920286/Amount"/></xsl:variable>
      <xsl:variable name="Amount920288">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920288/Amount"/></xsl:variable>
      <xsl:variable name="Amount920289">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920289/Amount"/></xsl:variable>
      <xsl:variable name="Amount920437">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920437/Amount"/></xsl:variable>
      <xsl:variable name="Amount920438">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920438/Amount"/></xsl:variable>
	 ...
	 <xsl:variable name="TotalAmount920290">
      ...
      <xsl:variable name="Amount920291">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920291/Amount"/></xsl:variable>
      <xsl:variable name="Amount920292">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920292/Amount"/></xsl:variable>
      <xsl:variable name="Amount920293">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920293/Amount"/></xsl:variable>
      <xsl:variable name="Amount920294">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920294/Amount"/></xsl:variable>
      <xsl:variable name="Amount920295">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920295/Amount"/></xsl:variable>
      <xsl:variable name="Amount920296">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920296/Amount"/></xsl:variable>
      <xsl:variable name="Amount920297">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920297/Amount"/></xsl:variable>
	
	  <xsl:variable name="Amount920439">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920439/Amount"/></xsl:variable>
	  <xsl:variable name="Amount920440">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920440/Amount"/></xsl:variable>
	  <xsl:variable name="Amount920441">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920441/Amount"/></xsl:variable>
	  <xsl:variable name="Amount920442">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920442/Amount"/></xsl:variable>
	  <xsl:variable name="Amount920443">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920443/Amount"/></xsl:variable>
      <xsl:variable name="Amount920444">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920444/Amount"/></xsl:variable>
	  <xsl:variable name="Amount920445">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920445/Amount"/></xsl:variable>
      ...
      <xsl:variable name="Amount920299">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920299/Amount"/></xsl:variable>
      ...
      <xsl:variable name="Amount920301">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920301/Amount"/> </xsl:variable>
      <xsl:variable name="Amount920302">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920302/Amount"/> </xsl:variable>
      <xsl:variable name="Amount920303">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920303/Amount"/> </xsl:variable>
      ...
      <xsl:variable name="Amount920306">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920306/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920307">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920307/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920308">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920308/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920309">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920309/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920310">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920310/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920311">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920311/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920313">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920313/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920314">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920314/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920315">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920315/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920316">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920316/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920317">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920317/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920319">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920319/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920320">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920320/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920322">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920322/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920323">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920323/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920324">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920324/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920326">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920326/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920327">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920327/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920331">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920331/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920332">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920332/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920333">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920333/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920334">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920334/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920336">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920336/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920337">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920337/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920338">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920338/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920339">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920339/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920341">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920341/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920342">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920342/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920344">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920344/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920345">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920345/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920346">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920346/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920347">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920347/Amount"/>
      </xsl:variable>

   
      <!-- 9 -->
      <xsl:variable name="Amount920349">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920349/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920350">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920350/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920351">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920351/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920352">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920352/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920354">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920354/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920355">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920355/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920356">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920356/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920357">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920357/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920359">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920359/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920360">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920360/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920361">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920361/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920362">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920362/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920363">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920363/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920364">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920364/Amount"/>
      </xsl:variable>
	  
	  <xsl:variable name="Amount920447">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920447/Amount"/>
      </xsl:variable>
	  
	  <xsl:variable name="Amount920448">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920448/Amount"/>
      </xsl:variable>
	  
	  <xsl:variable name="Amount920449">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920449/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920367">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920367/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920368">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920368/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920369">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920369/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920370">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920370/Amount"/>
      </xsl:variable>
	  
	  <xsl:variable name="Amount920451">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920451/Amount"/>
      </xsl:variable>
	  <xsl:variable name="Amount920452">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920452/Amount"/>
      </xsl:variable>
	  <xsl:variable name="Amount920453">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920453/Amount"/>
      </xsl:variable>
	  <xsl:variable name="Amount920454">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920454/Amount"/>
      </xsl:variable>
	 ...
	 <!-- 920423 -->
      <xsl:variable name="Amount920423">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920423/Amount"/>
      </xsl:variable>
	   <xsl:variable name="Amount920456">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920456/Amount"/>
      </xsl:variable>
  <xsl:variable name="Amount920457">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920457/Amount"/>
      </xsl:variable>
  <xsl:variable name="Amount920458">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920458/Amount"/>
      </xsl:variable>
<xsl:variable name="Amount920459">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920459/Amount"/>
      </xsl:variable>
  <xsl:variable name="Amount920460">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920460/Amount"/>
      </xsl:variable>
  <xsl:variable name="Amount920461">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920461/Amount"/>
      </xsl:variable>	  
      ...
      <xsl:variable name="Amount920371">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920371/Amount"/>
      </xsl:variable>

      <!-- 13 -->
      <xsl:variable name="Amount920373">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920373/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920374">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920374/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920375">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920375/Amount"/>
      </xsl:variable>

      <!-- 15 -->
	   <xsl:variable name="Amount920378">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920378/Amount"/>
      </xsl:variable>
	    <xsl:variable name="Amount920379">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920379/Amount"/>
      </xsl:variable>
	  <xsl:variable name="Amount920381">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920381/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920382">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920382/Amount"/>
      </xsl:variable>
	  <xsl:variable name="Amount920425">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920425/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920426">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920426/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920377">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920377/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920380">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920380/Amount"/>
      </xsl:variable>
	  <xsl:variable name="Amount920428">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920428/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920429">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920429/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920385">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920385/Amount"/>
      </xsl:variable>

      <!-- 17 -->
      <xsl:variable name="Amount920387">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920387/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920388">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920388/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920390">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920390/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920391">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920391/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920393">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920393/Amount"/>
      </xsl:variable>
      <xsl:variable name="Amount920394">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920394/Amount"/>
      </xsl:variable>
      ...
      <xsl:variable name="Amount920395">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920395/Amount"/>
      </xsl:variable>

      <!-- 21 -->
      <xsl:variable name="Amount920396">
        <xsl:value-of select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920396/Amount"/>
      </xsl:variable>
                  ...
                  <td width="95%">
                    ...
                    <table  class="displayTable"  width="50%">
                      <tr>
                        ...
                        <td width="80%" colspan="3">
                          ...
                          <xsl:value-of select="DS_CISC/CommonHeader/OrganizationId"/>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td width="80%" colspan="3">
                          <xsl:value-of select="DS_CISC/@name"/>
                        </td>
                      </tr>
                      <tr>
                        <td class="bgGreen" >Data Set Period Month :</td>
                        <td width="80%" colspan="3">
                          <xsl:value-of select="DS_CISC/DS_CISC_Header/DataSetPeriodMonth"/>
                        </td>
                      </tr>
                      <tr>
                        <td class="bgGreen"> </td>
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/CommonHeader">
                    ...
                    <table width="100%" class="displayTable">
                      ...
                      <tr>
					    ...
					    <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920430 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920430"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920430">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920431 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920431"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920431">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920432 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920432"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920432">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920433 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920433"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920433">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920434 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920434"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920434">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920435 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920435"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920435">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920436 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920436"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920436">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920254">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <td width="80%"  align="left" class="subFour labelXsl">
                          <xsl:value-of select="$name920421"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920421">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920422">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920256">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920257">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <!--<xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920258">-->
                          <td width="10%"  class="labelXsl" align="right">
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920259">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920260">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920261">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920262">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920264">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920266">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920267">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920268">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920270">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920271">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920272">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920273">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920274">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920275">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920277">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920279">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920280">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920281">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920282">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920284">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920285">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920286">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920288">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920289">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920437 </td>
                        <td width="80%"  align="left" class="subFour labelXsl">
                          <xsl:value-of select="$name920437"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920437">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920438 </td>
                        <td width="80%"  align="left" class="subFour labelXsl">
                          <xsl:value-of select="$name920438"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920438">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920291">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920292">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920293">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920294">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920295">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920296">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920297">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920439 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920439"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920439">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920440 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920440"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920440">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920441 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920441"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920441">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920442 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920442"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920442">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920443 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920443"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920443">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920444 </td>
                        <td width="80%"  align="left" class="subTwo labelXsl">
                          <xsl:value-of select="$name920444"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920444">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920445 </td>
                        <td width="80%"  align="left" class="subTwo labelXsl">
                          <xsl:value-of select="$name920445"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920445">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920299">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920301">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <td  bgcolor="#E7FFC8" width="10%" align="center">920302 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920302">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                     ...
                     <td  bgcolor="#E7FFC8" width="10%" align="center">920303 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920303">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920306 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920306">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920307">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920308">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920309 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920309">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920310 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920310">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920311 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920311">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920313">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920314">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920315">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920316 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920316">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920317 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920317">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                    ...
                    <td  bgcolor="#E7FFC8" width="10%" align="center">920319 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920319">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920320">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920322">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920323">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920324">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920326 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920326">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920327 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920327">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920331">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920332">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920333 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920333">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920334">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920336 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920336">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920337">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920338">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920339">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920341 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920341">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920342">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920344">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920345">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920346">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920347">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920349">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <td  bgcolor="#E7FFC8" width="10%" align="center">920350 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920350">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920351 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920351">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920352">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920354">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920355 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920355">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920356 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920356">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <td  bgcolor="#E7FFC8" width="10%" align="center">920357 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920357">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920359">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920360 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920360">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920361">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920362">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920363">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920364">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920367">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920368">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920369 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920369">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <td  bgcolor="#E7FFC8" width="10%" align="center">920370 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920370">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920371">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920373 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920373">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                     ...
                     <td  bgcolor="#E7FFC8" width="10%" align="center">920374 </td>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920374">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920375">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920424 </td>
                        <td width="80%"  align="left" class="subTwo labelXsl">
					  ...
					  <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920378">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920379">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920381">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920382">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920425 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920425"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920425">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					  ...
					  <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920426 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920426"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920426">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                       <td  bgcolor="#E7FFC8" width="10%" align="center">920427 </td>
                        <td width="80%"  align="left" class="subTwo labelXsl">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920377">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920380">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					    ...
					    <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920428 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920428"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920428">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
					   ...
					   <tr>
                        <td  bgcolor="#E7FFC8" width="10%" align="center">920429 </td>
                        <td width="80%"  align="left" class="subThree labelXsl">
                          <xsl:value-of select="$name920429"/>
                        </td>
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920429">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920385">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920387">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920388">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920390">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920391">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920395">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
                      ...
                      <tr>
                        ...
                        <xsl:for-each select="DS_CISC/DS_CISC_Content/ContentRecordGroup/ProfitAndLossItem920396">
                          <td width="10%"  class="labelXsl" align="right" >
                            <span style="color:#1500d4">
