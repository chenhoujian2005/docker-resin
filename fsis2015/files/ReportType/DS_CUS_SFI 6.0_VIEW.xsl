                    ...
                    <tr>
                        ...
                        <td width="95%">
                            ...
                            <table width="100%" class="displayTable" border="0">
								...
								<xsl:for-each select="DS_CUS/DS_CUS_Content/ContentRecordGroup">
                                    <xsl:if test="CardType  = '028068'">
                                        <tr>

                                            <td align="left" width="15%" class="labelXsl subThree">
                                                บัตรเดบิตที่ใช้จ่ายทั่วไป
                                            </td>
                                            <td align="center" class="labelXsl">
                                                <xsl:value-of
                                                        select="format-number(NumberOfCards,'###,###')"/>
								...
								<xsl:for-each select="DS_CUS">
                                    <xsl:if test="DS_CUS028070  != ''">
                                        <tr>
                                            <td align="left" width="15%" class="labelXsl subThree">
                                                บัตรร่วมไทยและบัตรร่วมต่างประเทศ
                                            </td>
                                            <td align="center" class="labelXsl">
                                            </td>
                                            <td align="center" width="15%" class="labelXsl">
								...
								<xsl:for-each select="DS_CUS/DS_CUS_Content/ContentRecordGroup">
                                    <xsl:if test="CardType  = '028071'">
                                        <tr>

                                            <td align="left" width="15%" class="labelXsl subFour">
                                                Thai Payment Network + UnionPay
                                            </td>
                                            <td align="center" class="labelXsl">
                                                <xsl:value-of
                                                        select="format-number(NumberOfCards,'###,###')"/>
								...
								<xsl:for-each select="DS_CUS/DS_CUS_Content/ContentRecordGroup">
                                    <xsl:if test="CardType  = '028073'">
                                        <tr>

                                            <td align="left" width="15%" class="labelXsl subThree">
                                                อืบัตรเดบิตจำกัดประเภทธุรกิจ
                                            </td>
                                            <td align="center" class="labelXsl">
                                                <xsl:value-of
                                                        select="format-number(NumberOfCards,'###,###')"/>
								...
								<xsl:for-each select="DS_CUS/DS_CUS_Content/ContentRecordGroup">
                                    <xsl:if test="CardType  = '028074'">
                                        <tr>

                                            <td align="left" width="15%" class="labelXsl subThree">
                                                บัตรเดบิตไม่จำกัดประเภทธุรกิจ
                                            </td>
                                            <td align="center" class="labelXsl">
                                                <xsl:value-of
                                                        select="format-number(NumberOfCards,'###,###')"/>
