                                ...
                                <tr>
                                    ...
                                    <td width="100%">
                                        ...
                                        <table class="displayTable" width="50%">
                                            <tr>
                                                ...
                                                <td width="15%" colspan="3">
                                                    <xsl:for-each select="DS_CRSC/CommonHeader">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <xsl:value-of select="DS_CRSC/@name"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="bgGreen"></td>
                                        ...
                                        <table class="displayTable" width="1800px">
                                            ...
                                            <xsl:for-each select="DS_CRSC/DS_CRSC_Content/ContentRecordGroup">
                                            ...
                                            <xsl:for-each select="BusinessGroupInfo/BusinessGroupDetails">
                                                ...
                                                <xsl:value-of select="$v_CreditRiskItemValue"/>
                                                    ...
                                                    <xsl:if test="$v_FtdAdjustment !=''">
                                                        <td class="labelXsl" align="right" width="100px">
