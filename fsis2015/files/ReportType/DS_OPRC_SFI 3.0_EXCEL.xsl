                                ...
                                <tr>
                                    <td width="100%">
                                        <table class="displayTable" width="50%" border="1">
                                            <tr>
                                                ...
                                                <td width="15%" colspan="3">
                                                    <xsl:for-each select="DS_OPRC/CommonHeader">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <xsl:value-of select="DS_OPRC/@name"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="bgGreen"></td>
                                        ...
                                        <table class="displayTable" width="100%"  border="1">
                                            ...
                                            <tr class="headTableXsl" align="center">
                                                <td width="10%">
                                            ...
                                            <xsl:for-each select="DS_OPRC/DS_OPRC_Content/ContentRecordGroup">
