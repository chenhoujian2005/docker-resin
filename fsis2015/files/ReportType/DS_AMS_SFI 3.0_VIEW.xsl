                                ...
                                <tr>
                                    ...
                                    <td width="95%">
                                        ...
                                        <table class="displayTable" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(MovementAmount018001,'###,##0.00')"/>
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018001"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                ...
                                                <xsl:if test="MovementAmount018002 != ''">
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(MovementAmount018002,'###,##0.00')"/>
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018002"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                            ...
                                            <xsl:for-each
                                                    select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                <xsl:if test="ArrangementType = '018003'">
                                                    <tr>
                                                        ...
                                                        <td align="right" class="labelXsl">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of
                                                                        select="format-number(MovementAmount,'###,##0.00')"/>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_AMS/MovementAmount018014"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                            ...
                                            <!-- <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_AMS/MovementAmount018023"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            &lt;!&ndash;</xsl:if>&ndash;&gt;
                                            ...
                                            <xsl:for-each
                                                    select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                <xsl:if test="ArrangementType = '018023'">
                                                    <tr>
                                                        <td class="labelXsl" align="center">
                                                            018023
                                                        </td>
                                            ...
                                            <!-- <tr>
                                              ...
                                              <td class="labelXsl" align="right">
                                                    <span style="color:#1500d4">
                                                        <xsl:value-of select="DS_AMS/MovementAmount018114"/>
                                                    </span>
                                                </td>
                                            </tr>-->
                                            <!--</xsl:if>-->
                                            ...
                                            <!--   <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                ...
                                                &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                     &lt;!&ndash;<xsl:if test="ArrangementType = '018033' or ArrangementType = '018034' or ArrangementType = '018035'">&ndash;&gt;
                                                     <tr>
                                                        <td class="labelXsl" align="center">
                                                            018032
                                                        </td>
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <xsl:value-of select="DS_AMS/MovementAmount018032"/>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                     &lt;!&ndash;</xsl:if>&ndash;&gt;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <span style="color:#1500d4">
                                                                    <xsl:value-of
                                                                            select="format-number(MovementAmount018032,'###,##0.00')"/>
                                                                </span>
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018033"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                ...
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018035"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <span style="color:#1500d4">
                                                                    <xsl:value-of
                                                                            select="format-number(MovementAmount018037,'###,##0.00')"/>
                                                                </span>
                                                                <!--<xsl:value-of select="MovementAmount018037"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                ...
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018038"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                ...
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018041"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                            ...
                                            <!-- <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018046' or ArrangementType = '018049'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018045
                                                     </td>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018045"/>
                                                         </span>
                                                     </td>
                                                 </tr>-->
                                            <!--</xsl:if>-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                <span style="color:#1500d4">
                                                                    <xsl:value-of
                                                                            select="format-number(MovementAmount018045,'###,##0.00')"/>
                                                                </span>
                                                                <!--<xsl:value-of select="MovementAmount018045"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="labelXsl" align="right">
                                                            <span style="color:#1500d4">
                                                                ...
                                                                <!--<xsl:value-of select="DS_AMS/MovementAmount018046"/>-->
                                                            </span>
                                                        </td>
                                                    </tr>
                                                </xsl:if>
                                            ...
                                            <!-- <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018051' or ArrangementType = '018052' or ArrangementType = '018053'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018050
                                                     </td>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018050"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                  &lt;!&ndash;</xsl:if>&ndash;&gt;
                                             ...
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                  ...
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018055'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018055
                                                     </td>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018055"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018280"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018081'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018081
                                                     </td>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018081"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                  &lt;!&ndash;</xsl:if>&ndash;&gt;
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018086'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018087
                                                     </td>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018087"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                  &lt;!&ndash;</xsl:if>&ndash;&gt;
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018305'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018305
                                                     </td>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018305"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                  &lt;!&ndash;</xsl:if>&ndash;&gt;
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018310'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018310
                                                     </td>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018310"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                  &lt;!&ndash;</xsl:if>&ndash;&gt;
                                             ...
                                             &lt;!&ndash;<xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">&ndash;&gt;
                                                  &lt;!&ndash;<xsl:if test="ArrangementType = '018315'">&ndash;&gt;
                                                  <tr>
                                                     <td class="labelXsl" align="center">
                                                         018316
                                                     </td>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018316"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                  &lt;!&ndash;</xsl:if>&ndash;&gt;
                                             ...
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                              ...
                                              <tr>
                                                  ...
                                                  <tr>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018096"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                 <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                  ...
                                                  <tr>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018099"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                             <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018100"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018105"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                             <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                             ...
                                             <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                         <span style="color:#1500d4">
                                                             <xsl:value-of select="DS_AMS/MovementAmount018108"/>
                                                         </span>
                                                     </td>
                                                 </tr>
                                                 <xsl:for-each select="DS_AMS/DS_AMS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                            ...
                                            <!--<span style="color:#1500d4">-->
                                            <!--<xsl:value-of-->
                                            <!--select="format-number(MovementAmount,'###,###,###.00')"/>-->
                                            <!--</span>-->
                                            <!--</td>-->
                                            <!--</tr>-->
                                            <!--</xsl:for-each>-->
