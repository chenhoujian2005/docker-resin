...
<body>
<s:form action="defined_unstructured" id="defined_unstructured">
              ...
              <table width="100%" border="0" align="center" style="height:100%">
                <tr>
                  <td>
                    ...
                    <table width="100%">
                      <tr>
                        <td width="50%"><b>Defined Unstructured</b></td>
                        <td width="50%" align="right">
                          <c:if test="${sessionScope.menuAuthentication.definedDataManage}">
                            <input type="button" class="button" id="btnNew" value="Add Defined Unstructured" style="width:150px" onclick="letsGo('defined_unstructured_input.action', '')"/>
                          </c:if>
                        </td>
                      </tr>
                    </table>
                    ...
                    <display:table name="definedDataList" id="row" export="false" class="displayTag" requestURI="defined_unstructured.action" style="width:100%;text-align:center" pagesize="15">
                      <display:column title="Dataset Date From"  style="width:10%;text-align:center" headerClass="headerTable" sortable="true">
                        <a href="#" onclick="letsGo('defined_unstructured_detail.action','${row.id}')"> <fmt:formatDate pattern="dd MMM yyyy" value="${row.datasetDateFrom}" /> </a>
                      </display:column>
                      <display:column title="Dataset Date To"  style="width:10%;text-align:center" headerClass="headerTable" sortable="true">
                        <a href="#" onclick="letsGo('defined_unstructured_detail.action','${row.id}')"> <fmt:formatDate pattern="dd MMM yyyy" value="${row.datasetDateTo}" /> </a>
                      </display:column>
                      ...
                      <c:if test="${sessionScope.menuAuthentication.definedDataManage}">
                        <display:column title="Edit" style="width:5%;text-align:center" headerClass="headerTable">
                          <img src=../images/edit.gif border="no" align="" onclick="letsGo('defined_unstructured_input.action','${row.id}')" style="cursor:pointer">
                        </display:column>
