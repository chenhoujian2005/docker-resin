...
<head>
  ...
  <script type="text/javascript">
    function resetForm() {
      thisForm.sfis.selectedIndex = 0;
      thisForm.year.selectedIndex = 0;
    }

    function validateForm() {
      //alert(thisForm.sfis.selectedIndex);
      if (thisForm.sfis.selectedIndex == -1) {
        alert('Please Select SFIs Name');
        thisForm.sfis.focus();
        return false;
      }
      if (thisForm.dataSetName.selectedIndex == -1) {
        alert('Please Select Dataset Name');
        thisForm.dataSetName.focus();
        return false;
      }
...
<body>
<s:form action="kpi_report_structured_by_search_bot" id="kpi_report_structured_by_search_bot"
        name="kpi_report_structured_by_search_bot" validate="false">
              ...
              <table width="100%" border="0" align="center" style="height:100%">
                <tr>
                  <td>
                    ...
                    <table width="100%">
                      <tr>
                        <td width="100%" colspan="2">
                          <b>KPI Report Structured By Search</b>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <table width="100%" class="displayTable">
                            ...
                            <tr class="bgGreen1">
                              <td class="label">Dataset Name<span class="require_field">*</span> :</td>
                              <td>
                    ...
                    <c:if test="${not empty requestScope.kpiReportDTOList || not empty requestScope.kpiReportFortnightlyDTOList}">
                      <table>
                        <tr>
                          <td colspan="17" align="left">
                            <input type="button" class="button" value="Print" onclick="window.print();return false;"/>
                            <input type="button" value="Convert To Excel" class="button" id="convertExcel"  style="width:150px" onclick="letsGo('kpi_report_structured_by_search_convert_to_excel.action')"/>
                              <%--<a class="button" style="height:18px;width:150px;vertical-align:bottom;text-align:center;"--%>
                              <%--href="../report/kpi_report_structured_by_search_convert_to_excel.action">&nbsp;Convert To Excel&nbsp;</a>--%>
                          </td>
                        </tr>
                      </table>
                    </c:if>
                    <c:if test="${not empty requestScope.kpiReportDTOList}">
                      ...
                      <table id="tableResult" width="${tableWidth}" border="1" bordercolor="5A9113" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                          ...
                          <th scope="col" width="${resultWidth}" class="headerTable">SFI Name</th>
                        ...
                        <c:forEach items="${requestScope.kpiReportDTOList}" var="row" varStatus="status">
                          <tr>
                            ...
                            <td style=";text-align:left">${row[30]}</td>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[4]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[5] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[5] && row[44] ne '5'}">
                                        <c:if test="${row[5]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td> </c:if>
                                        <c:if test="${row[5]>=dateNow}"> <td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[5] && row[44] eq '5'}">
                                ...
                                <c:choose>
                                  <c:when test="${empty row[6]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[7] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[7] && row[44] ne '5'}">
                                        <c:if test="${row[7]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[7]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[7] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[8]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[9] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[9] && row[44] ne '5'}">
                                        <c:if test="${row[9]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[9]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[9] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[10]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[11] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[11] && row[44] ne '5'}">
                                        <c:if test="${row[11]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[11]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[11] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[12]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[13] && row[44] ne '5'}"> <td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[13] && row[44] ne '5'}">
                                        <c:if test="${row[13]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[13]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[13] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[14]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[15] && row[44] ne '5'}"> <td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[15] && row[44] ne '5'}">
                                        <c:if test="${row[15]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[15]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[15] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[16]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[17] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[17] && row[44] ne '5'}">
                                        <c:if test="${row[17]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[17]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[17] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[18]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[19] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[19] && row[44] ne '5'}">
                                        <c:if test="${row[19]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[19]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[19] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[20]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[21] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[21] && row[44] ne '5'}">
                                        <c:if test="${row[21]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[21]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[21] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row[22]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row[23] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[23] && row[44] ne '5'}">
                                        <c:if test="${row[23]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[23]>=dateNow}"><td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[23] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                              ...
                              <c:otherwise>
                                <c:choose>
                                  <c:when test="${empty row[24]}">
                                    <c:choose>
                                      <c:when test="${row[42] eq 'waive'}"><td style=";text-align:center" bgcolor="#9999ff"></td></c:when>
                                      <c:when test="${empty row[25] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[25] && row[44] ne '5'}">
                                        <c:if test="${row[25]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[25]>=dateNow}"> <td style=";text-align:center">-</td></c:if>
                                      </c:when>
                                      <c:when test="${!empty row[25] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                              ...
                              <c:otherwise>
                                <c:choose>
                                  <c:when test="${empty row[26]}">
                                    <c:choose>
                                      <c:when test="${row[43] eq 'waive'}"><td style=";text-align:center" bgcolor="#9999ff"></td></c:when>
                                      <c:when test="${empty row[27] && row[44] ne '5'}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row[27] && row[44] ne '5'}">
                                        <c:if test="${row[27]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                        <c:if test="${row[27]>=dateNow}"><td style=";text-align:center">-</td> </c:if>
                                      </c:when>
                                      <c:when test="${!empty row[27] && row[44] eq '5'}">
                                        <c:if test="${year < yearNow}"><td style=";text-align:center">No Change</td></c:if>
                      ...
                      <table id="tableResult" width="${tableWidth}" border="1" bordercolor="5A9113" cellpadding="0" cellspacing="0"
                        ...
                        <c:forEach items="${requestScope.kpiReportFortnightlyDTOList}" var="row2">
                          <tr>
                            ...
                            <td style=";text-align:left">${row2[30]}</td>
                                  ...
                                  <c:when test="${empty row2[4]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[5]}">
                                        <c:if test="${row2[5]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td> </c:if>
                                  ...
                                  <c:when test="${empty row2[6]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[7]}">
                                        <c:if test="${row2[7]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[8]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[9]}">
                                        <c:if test="${row2[9]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[10]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[11]}">
                                        <c:if test="${row2[11]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[12]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[13]}">
                                        <c:if test="${row2[13]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[14]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[15]}">
                                        <c:if test="${row2[15]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                ...
                                <c:choose>
                                  <c:when test="${empty row2[16]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${empty row2[17]}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row2[17]}">
                                        <c:if test="${row2[17]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[18]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[19]}">
                                        <c:if test="${row2[19]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[20]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[21]}">
                                        <c:if test="${row2[21]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                                  ...
                                  <c:when test="${empty row2[22]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row2[23]}">
                                        <c:if test="${row2[23]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                              ...
                              <c:otherwise>
                                <c:choose>
                                  <c:when test="${empty row2[24]}">
                                    <c:choose>
                                      <c:when test="${row2[42] eq 'waive'}"><td style=";text-align:center" bgcolor="#9999ff"></td></c:when>
                                      <c:when test="${empty row2[25]}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row2[25]}">
                                        <c:if test="${row2[25]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
                              ...
                              <c:otherwise>
                                <c:choose>
                                  <c:when test="${empty row2[26]}">
                                    <c:choose>
                                      <c:when test="${row2[43] eq 'waive'}"><td style=";text-align:center" bgcolor="#9999ff"></td></c:when>
                                      <c:when test="${empty row2[27]}"><td style=";text-align:center" bgcolor="#a9a9a9"></td></c:when>
                                      <c:when test="${!empty row2[27]}">
                                        <c:if test="${row2[27]<dateNow}"><td style=";text-align:center" bgcolor="#ffccff"></td></c:if>
