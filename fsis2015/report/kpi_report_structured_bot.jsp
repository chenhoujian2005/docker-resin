...
<body>
<s:form action="kpi_report_structured_bot" id="kpi_report_structured_bot" name="kpi_report_structured_bot" validate="false">
                  ...
                  <td>
                                  ...
                                  <c:when test="${empty row[4]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[5] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 1 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 1 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:when test="${empty row[6]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[7] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 2 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 2 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[7]>=row[6]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br> ${row[6]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[7]<row[6]}">
                                  ...
                                  <c:when test="${empty row[8]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[9] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 3 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 3 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:when test="${empty row[10]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[11] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 4 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 4 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[11]>=row[10]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[10]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[11]<row[10]}">
                                  ...
                                  <c:when test="${empty row[12]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[13] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 5 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 5 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[13]>=row[12]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[12]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[13]<row[12]}">
                                  ...
                                  <c:when test="${empty row[14]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[15] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 6 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 6 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[15]>=row[14]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br> ${row[14]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[15]<row[14]}">
                                  ...
                                  <c:when test="${empty row[16]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[17] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 7 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 7 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[17]>=row[16]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br> ${row[16]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[17]<row[16]}">
                                        <td style="text-align:center"><img src="../images/windows-error_16x16.gif"/><br> ${row[16]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[3] eq 'เมื่อมีการเปลี่ยนแปลง'}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[16]}
                                  ...
                                  <c:when test="${empty row[18]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[19] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 8 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 8 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[19]>=row[18]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[18]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[19]<row[18]}">
                                  ...
                                  <c:when test="${empty row[20]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[21] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 9 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 9 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[21]>=row[20]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[20]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[21]<row[20]}">
                                  ...
                                  <c:when test="${empty row[22]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[23] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 10 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 10 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[23]>=row[22]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[22]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[23]<row[22]}">
                                  ...
                                  <c:when test="${empty row[24]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[25] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 11 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 11 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[25]>=row[24]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row[24]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[25]<row[24]}">
                                  ...
                                  <c:when test="${empty row[26]}">
                                    <c:choose>
                                      ...
                                      <c:when test="${!empty row[27] && row[42] eq '5'}">
                                        ...
                                        <c:if test="${year >= yearNow && monthNow <= 12 }">
                                          <td style="text-align:center">-</td>
                                        </c:if>
                                        <c:if test="${year >= yearNow && monthNow > 12 }">
                                          <td style="text-align:center">No Change</td>
                                  ...
                                  <c:otherwise>
                                    <c:choose>
                                      <c:when test="${row[27]>=row[26]}">
                                        <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br> ${row[26]}
                                        </td>
                                      </c:when>
                                      <c:when test="${row[27]<row[26]}">
                    ...
                    <c:if test="${not empty requestScope.kpiReportFortnightlyDTOList}">
                      <table id="tableResult" width="${tableWidth}" border="1" bordercolor="5A9113" cellpadding="0" cellspacing="0"
                        ...
                        <c:forEach items="${requestScope.kpiReportFortnightlyDTOList}" var="row2" varStatus="theCount">
                          ...
                          <c:choose>
                            <c:when test="${theCount.count%2 == 0}">
                              <tr>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[4]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[45]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[5]>=row2[4]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br> ${row2[4]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[5]<row2[4]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[6]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[46]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[7]>=row2[6]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[6]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[7]<row2[6]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[8]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[47]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[9]>=row2[8]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[8]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[9]<row2[8]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[10]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[48]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[11]>=row2[10]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[10]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[11]<row2[10]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[12]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[49]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[13]>=row2[12]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[12]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[13]<row2[12]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[14]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[50]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[15]>=row2[14]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[14]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[15]<row2[14]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[16]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[51]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[17]>=row2[16]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[16]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[17]<row2[16]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[18]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[52]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[19]>=row2[18]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[18]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[19]<row2[18]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[20]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[53]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[21]>=row2[20]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[20]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[21]<row2[20]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[22]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[54]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[23]>=row2[22]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[22]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[23]<row2[22]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[24]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[55]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[25]>=row2[24]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[24]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[25]<row2[24]}">
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[26]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[56]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                      ...
                                      <c:otherwise>
                                        <c:choose>
                                          <c:when test="${row2[27]>=row2[26]}">
                                            <td style="text-align:center"><img src="../images/windows-success_16x16.gif"/><br>${row2[26]}
                                            </td>
                                          </c:when>
                                          <c:when test="${row2[27]<row2[26]}">
                            ...
                            <c:otherwise>
                              <tr>
                                <td style="text-align:center" rowspan="2">
                                  <c:out value="${index2}"/>
                                  <c:set var="index2" value="${index2 + 1}"/></td>
                                <td style="text-align:center" rowspan="2">${row2[57]}</td>
                                <td style="text-align:center" rowspan="2">${row2[58]}</td>
                                <td style="text-align:center" rowspan="2">${row2[59]}</td>
                                <td style="text-align:center" rowspan="2">${row2[60]}</td>
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[45]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[4]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[46]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[6]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[47]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[8]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[48]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[10]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[49]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[12]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[50]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[14]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[51]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[16]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[52]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[18]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[53]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[20]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[54]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[22]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[55]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[24]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
                                ...
                                <c:choose>
                                  <c:when test="${(row2[44] eq 'AAA')}">
                                    <td style="text-align:center" bgcolor="#00EEEE">
                                      <fmt:formatDate value="${row2[56]}" pattern="dd MMM"/> -
                                      <fmt:formatDate value="${row2[26]}" pattern="dd MMM yy"/>
                                    </td>
                                  </c:when>
                                  <c:otherwise>
                                    <c:choose>
