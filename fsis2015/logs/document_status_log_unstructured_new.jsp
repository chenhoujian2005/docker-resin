...
<table width="100%" class="displayTable">
    <tr class="bgGreen2">
        ...
        <td width="20%">
            <s:textfield name="dsDateFrom" size="8" readonly="true"/>
        ...
        <td width="55%">
            <s:textfield name="dsDateTo" size="8" readonly="true"/>
            <img border="0" src="../images/dd.gif" name="dateBtn" width="15" height="15"
...
<c:if test="${requestScope.objectList ne null}">
   <display:table name="${requestScope.objectList}" id="row" export="false" class="displayTag" requestURI="document_status_log_unstructured.action" style="width:100%;"  pagesize="20">
        <display:column title="SFIs Name" property="sfiName" headerClass="headerTable" sortable="true" style="width:12%;text-align:left"/>
        <display:column title="Dataset Name" headerClass="headerTable" sortable="true" style="width:35%;text-align:left">
           <c:choose>
        ...
        <display:column title="Frequency" property="frequencyName" headerClass="headerTable" sortable="true" style="width:13%;text-align:left"/>
        ...
        <display:column title="Upload Date" property="strUploadDate"  headerClass="headerTable" sortable="true" style="width:8%;text-align:center"/>
        <display:column title="Document Status" property="status" headerClass="headerTable" sortable="true" style="width:8%;text-align:center"/>
...
<c:if test="${requestScope.objectList ne null and requestScope.objectList ne '[]'}">
        <table width="100%">
            <tr>
