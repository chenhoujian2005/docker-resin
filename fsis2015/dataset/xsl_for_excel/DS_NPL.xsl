                ...
                <table class="displayTable" width="50%" border="1">
                                        ...
                                        <table class="displayTable" width="100%" border="1">
                                            <tr class="headTableXsl">
                                                <td align="center" colspan="3">NPL</td>
                                            </tr>
                                            <tr class="headTableXsl">
                                                <td width="80%" align="center">NPL Item</td>
                                                <td width="20%" align="center" colspan="2">Amount</td>
                                            </tr>
                                        </table>
                                        <table border="1" width="100%" class="displayTable">
                                            <tr>
                                                ...
                                                <td align="right" class="labelXsl">
                                                    <xsl:if test="not(Amount='')">
                                                        <xsl:for-each
                                                                select="DS_NPL/DS_NPL_Content/ContentRecordGroup/NPLItem502001">
                                            ...
                                            <tr>
                                                <td align="center" class="labelXsl">502018</td>
                                                 <td width="70%" class="subOne labelXsl">
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td align="right" class="labelXsl">
                                                        <span style="color:#1500d4"><xsl:value-of
                                                                select="format-number(Amount,'###,###,###,###,###.00')"/> </span>
                                                    </td>
