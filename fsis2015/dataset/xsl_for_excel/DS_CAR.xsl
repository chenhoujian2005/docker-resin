                        ...
                        <tr>
                            ...
                            <td class="labelXsl" align="right">
                                <xsl:if test="NotionalAmount != ''">
                                    <span style="color:#1500d4">
                                        <xsl:value-of select="format-number(NotionalAmount,'###,###,###,###,##0.00')"/>
                                    </span>
                                </xsl:if>
                            </td>
                            <td class="labelXsl">
                            ...
                            <td class="labelXsl" align="right">
                                <xsl:if test="OutstandingAmount != ''">
                                    <span style="color:#1500d4">
                                        <xsl:value-of
                                                select="format-number(OutstandingAmount,'###,###,###,###,##0.00')"/>
                                    </span>
                                </xsl:if>
                            </td>
                            <td class="labelXsl">
                                    ...
                                    <xsl:for-each select="CollateralGroupInfo/CollateralGroupDetails">
                                        <tr>
                                            <td>
                                                <span style="color:#1500d4">
                                                    <xsl:value-of
                                                            select="format-number(CollateralValueAmount,'###,###,###,###,##0.00')"/>
                                                </span>
                                            </td>
                                        </tr>
                                    </xsl:for-each>
                                    ...
                                    <xsl:for-each select="CollateralGroupInfo/CollateralGroupDetails">
                                        <tr>
                                            <td>
                                                <span style="color:#1500d4">
                                                    <xsl:value-of
                                                            select="format-number(CollateralPledgedAmount,'###,###,###,###,##0.00')"/>
                                                </span>
                                            </td>
                                        </tr>
                                    </xsl:for-each>
