            ...
            <body>
                <table class="displayTable" width="50%" border="1">
                    <tr>
                        ...
                        <td width="15%" colspan="2">
                            <xsl:for-each select="DS_TDR/CommonHeader">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <xsl:value-of select="DS_TDR/@name"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="bgGreen"></td>
                ...
                <table width="100%" class="displayTable" border="1">
                    <tr class="headTableXsl">
                        ...
                        <td align="center">
                            Outstanding or Movement Amount
                        </td>
                        <td align="center">
                            Accrued Interest Amount
                        </td>
                    </tr>
                    <xsl:for-each select="DS_TDR/DS_TDR_Content/ContentRecordGroup">
                        <tr>
                            ...
                            <td align="center" class="labelXsl">
                                <xsl:value-of select="TdrStatus"/>
                            </td>
                            <td align="center" class="labelXsl">
                                <xsl:value-of select="NumberOfCustomers"/>
                            </td>
                            <td align="right" class="labelXsl">
                                <span style='color:#1500d4'>
                                    <xsl:value-of select="format-number(OutstandingOrMovementAmount,'###,##0.00')"/>
                                </span>
                            </td>
                            <td align="right" class="labelXsl">
                                <span style='color:#1500d4'>
                                    <xsl:value-of select="format-number(AccruedInterestAmount,'###,##0.00')"/>
                                </span>
                            </td>
                        </tr>
                    </xsl:for-each>
