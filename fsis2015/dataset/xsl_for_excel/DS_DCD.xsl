                        ...
                        <tr>
                            ...
                            <td align="center" class="labelXsl">
                                <span style="color:#1500d4">
                                    <xsl:value-of
                                            select="format-number(NumberOfCustomers,'###,###,###,###,###,###,###,###')"/>
                                </span>
                            </td>
                            <td align="center" class="labelXsl">
                                <xsl:value-of
                                        select="ArrangementOutstandingInfo/ArrangementOutstandingDetails/ArrangementType"/>
                            </td>
                            <td align="left" class="labelXsl">
                                <xsl:value-of
                                        select="ArrangementOutstandingInfo/ArrangementOutstandingDetails/ArrangementTypeValue"/>
                            </td>
                            <td align="center" class="labelXsl">
                                <span style="color:#1500d4">
                                    <xsl:value-of
                                            select="format-number(ArrangementOutstandingInfo/ArrangementOutstandingDetails/TotalOutstandingAmount,'###,###,###,###,###,###,###,##0.00')"/>
                                </span>
                            </td>
                        </tr>
                    </xsl:for-each>
