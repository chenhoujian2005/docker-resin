...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="InvolvedPartyType">Involved Party Type</xsl:variable>
            <xsl:variable name="ArrangementTypeValue">Arrangement Type Description </xsl:variable>
            <xsl:variable name="InvolvedPartyTypeValue">Involved Party Type Description</xsl:variable>
            <xsl:variable name="RwaRate">Rwa Rate</xsl:variable>
            <xsl:variable name="CcfRate">Ccf Rate</xsl:variable>
            <xsl:variable name="ArrangementTermRange">Arrangement Term Range</xsl:variable>
            <xsl:variable name="RemainingTermRange">Remaining Term Range</xsl:variable>
            <xsl:variable name="RepricingTermRange">Repricing Term Range</xsl:variable>
            <xsl:variable name="ArrangementCurrencyFlag">Arrangement Currency Flag</xsl:variable>
            <xsl:variable name="OutstandingAmountRange">Outstanding Amount Range</xsl:variable>
            <xsl:variable name="NumberOfAccounts">Number of Accounts</xsl:variable>
            <xsl:variable name="TotalOutstandingAmount">Total Outstanding Amount</xsl:variable>
            <head>
            ...
            <body>
                                        ...
                                        <table class="displayTable" width="50%" border="1">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <xsl:value-of select="DS_ARS/@name"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="bgGreen"></td>
                                        ...
                                        <table class="displayTable" width="1200px" border="1">
                                            <tr class="headTableXsl">
                                                ...
                                                <td >
                                                    <xsl:value-of select="$ArrangementTermRange"/>
                                                </td>
                                                <td >
                                                    <xsl:value-of select="$RemainingTermRange"/>
                                                </td>
                                                <td >
                                                ...
                                                <td >
                                                    <xsl:value-of select="$OutstandingAmountRange"/>
                                                </td>
                                                <td >
                                                    <xsl:value-of select="$NumberOfAccounts"/>
                                                </td>
                                                <td >
                                                    <xsl:value-of select="$TotalOutstandingAmount"/>
                                                </td>
                                            </tr>
                                              <xsl:for-each select="DS_ARS">
											...
											<xsl:if test="TotalOutstandingAmount018001 != ''">
                                              <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
														...
														<xsl:value-of select="format-number(TotalOutstandingAmount018001,'###,##0.00')"/>
											...
											<xsl:if test="TotalOutstandingAmount018002 != ''">
                                             <tr>
                                                ...
                                                <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018002,'###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            </xsl:for-each>
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                            <xsl:if test="ArrangementType = '018003'">
                                                  <tr>
                                                    ...
                                                    <td class="labelXsl" align="center">
                                                        <xsl:if test="not(CcfRate='')">
                                                            <xsl:value-of
                                                                    select="format-number(CcfRate,'###,###,###,###.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td class="labelXsl" align="center">
                                                        <xsl:if test="not(RwaRate='')">
                                                            <xsl:value-of
                                                                    select="format-number(RwaRate,'###,###,###,###.00')"/>
                                                        </xsl:if>
                                                    </td>
                                                    <td class="labelXsl" align="center">
                                                        <xsl:value-of select="InvolvedPartyType"/>
                                                    ...
                                                    <xsl:variable name="Accounts"><xsl:value-of select="NumberOfAccounts"/></xsl:variable>
                                                    ...
                                                    <td class="labelXsl" align="center">
                                                        <xsl:value-of
                                                                select="format-number(NumberOfAccounts,'###,###,###,###')"/>
                                                    </td>
                                                     </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS">
		                         <xsl:if test="TotalOutstandingAmount018004 != ''">
                                            <tr>
                                                    <td class="labelXsl" align="center">
                                                         018004
                                                    </td>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018004,'###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
														<xsl:value-of select="format-number(TotalOutstandingAmount018014,'###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
											...
											<xsl:if test="TotalOutstandingAmount018023 != ''">
                                             <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number(TotalOutstandingAmount018023,'###,##0.00')"/></span>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018023"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
											...
											<xsl:if test="TotalOutstandingAmount018114 != ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018114,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018114"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                           ...
                                           <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
											...
											<xsl:if test="TotalOutstandingAmount018032 != ''">
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018032"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
											...
											<xsl:if test="TotalOutstandingAmount018033 = ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018033,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018033"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS">
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018035"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                             </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS">
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018037,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018037"/>-->
                                                        </span>
                                                    </td>
                                                        </tr>
                                                     </xsl:if>
		        ...
		        <xsl:if test="TotalOutstandingAmount018038 = ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018038,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018038"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		  ...
		  <xsl:if test="TotalOutstandingAmount018041 = ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018041,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018041"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		                    ...
		                    <xsl:if test="TotalOutstandingAmount018045 = ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018045,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018045"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		            ...
		            <xsl:if test="TotalOutstandingAmount018046 = ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018046,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018046"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		  ...
		  <xsl:if test="TotalOutstandingAmount018049 = ''">
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018049,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018049"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		  ...
		  <xsl:if test="TotalOutstandingAmount018050 != ''">
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018050,'###,##0.00')"/>
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018050"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                             </xsl:if>
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018055"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		  ...
		  <xsl:if test="TotalOutstandingAmount018280 != ''">
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018280"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                 <xsl:if test="ArrangementType = '018081'">
                                                 <tr>
                                                    <td class="labelXsl" align="center">
                                                        018281
                                                    </td>
                                            ...
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018081"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018087"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                 <xsl:if test="ArrangementType = '018305'">
                                                 <tr>
                                                    <td class="labelXsl" align="center">
                                                        018305
                                                    </td>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018305"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                 <xsl:if test="ArrangementType = '018310'">
                                                 <tr>
                                                    <td class="labelXsl" align="center">
                                                        018310
                                                    </td>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018310"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_ARS/DS_ARS_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="DS_ARS/TotalOutstandingAmount018316"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018096"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018099"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018100"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018105"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <tr>
                                                 ...
                                                 <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            ...
                                                            <!--<xsl:value-of select="DS_ARS/TotalOutstandingAmount018108"/>-->
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
