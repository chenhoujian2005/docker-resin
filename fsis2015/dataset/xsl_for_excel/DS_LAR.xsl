                ...
                <table width="100%" class="displayTable" border="1">
                    ...
                    <xsl:for-each select="DS_LAR/DS_LAR_Content/ContentRecordGroup">
                        <tr>
                            ...
                            <xsl:variable name="PrincipalHair-CutAmountVar">
                                <xsl:value-of select="PrincipalHairCutAmount"/>
                            </xsl:variable>
                            <xsl:if test="$PrincipalHair-CutAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($PrincipalHair-CutAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$PrincipalHair-CutAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="InterestHair-CutAmountVar">
                                <xsl:value-of select="InterestHairCutAmount"/>
                            </xsl:variable>
                            <xsl:if test="$InterestHair-CutAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($InterestHair-CutAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$InterestHair-CutAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="VATWaivedAmountVar">
                                <xsl:value-of select="VatWaivedAmount"/>
                            </xsl:variable>
                            <xsl:if test="$VATWaivedAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($VATWaivedAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$VATWaivedAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="BusinessTaxWaivedAmountVar">
                                <xsl:value-of select="BusinessTaxWaivedAmount"/>
                            </xsl:variable>
                            <xsl:if test="$BusinessTaxWaivedAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($BusinessTaxWaivedAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$BusinessTaxWaivedAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="OtherTaxWaivedAmountVar">
                                <xsl:value-of select="OtherTaxWaivedAmount"/>
                            </xsl:variable>
                            <xsl:if test="$OtherTaxWaivedAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($OtherTaxWaivedAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$OtherTaxWaivedAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="OtherArrangementNumberVar">
                                <xsl:value-of select="RelatedArGroupInfo/RelatedArGroupDetails/OtherArrangementNumber"/>
                            </xsl:variable>
                            <xsl:if test="$OtherArrangementNumberVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($OtherArrangementNumberVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$OtherArrangementNumberVar =''">
                                <td class="labelXsl"/>
                            ...
                            <td width="10%" class="labelXsl">
                                <xsl:value-of
                                        select="RelatedArGroupInfo/RelatedArGroupDetails/ArArRelationshipTypeValue"/>
                            </td>
                            <td width="10%" class="labelXsl">
                                <xsl:value-of
                                        select="RelatedIpGroupInfo/RelatedIpGroupDetails/RelatedInvolvedPartyIdValue"/>
                            </td>
                            <td width="10%" class="labelXsl">
                                <xsl:value-of
                                        select="RelatedIpGroupInfo/RelatedIpGroupDetails/RelatedUniqueIdTypeValue"/>
                            </td>
                            <td width="10%" class="labelXsl">
                                <xsl:value-of
                                        select="RelatedIpGroupInfo/RelatedIpGroupDetails/IpArRelationshipTypeValue"/>
                            </td>
                            <xsl:variable name="OutstandingAmountVar">
                                <xsl:value-of select="OutstandingAmount"/>
                            </xsl:variable>
                            <xsl:if test="$OutstandingAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($OutstandingAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$OutstandingAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="AccruedInterestAmountVar">
                                <xsl:value-of select="AccruedInterestAmount"/>
                            </xsl:variable>
                            <xsl:if test="$AccruedInterestAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($AccruedInterestAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$AccruedInterestAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="SuspendedInterestAmountVar">
                                <xsl:value-of select="SuspendedInterestAmount"/>
                            </xsl:variable>
                            <xsl:if test="$SuspendedInterestAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($SuspendedInterestAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$SuspendedInterestAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="CashFlowValueAmountVar">
                                <xsl:value-of select="CashFlowValueAmount"/>
                            </xsl:variable>
                            <xsl:if test="$CashFlowValueAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($CashFlowValueAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$CashFlowValueAmountVar =''">
                                <td class="labelXsl"/>
                            ...
                            <xsl:variable name="CollateralValueAmountVar">
                                <xsl:value-of
                                        select="CollateralGroupInfo/CollateralGroupDetails/CollateralValueAmount"/>
                            </xsl:variable>
                            <xsl:if test="$CollateralValueAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($CollateralValueAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$CollateralValueAmountVar =''">
                                <td class="labelXsl"/>
                            </xsl:if>
                            <xsl:variable name="CollateralPledgedAmountVar">
                                <xsl:value-of
                                        select="CollateralGroupInfo/CollateralGroupDetails/CollateralPledgedAmount"/>
                            </xsl:variable>
                            <xsl:if test="$CollateralPledgedAmountVar !=''">
                                <td width="10%" class="labelXsl">
                                    <xsl:value-of
                                            select="format-number($CollateralPledgedAmountVar,'###,###,###,###,###,###,###,##0.00')"/>
                                </td>
                            </xsl:if>
                            <xsl:if test="$CollateralPledgedAmountVar =''">
                                <td class="labelXsl"/>
