...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="name950015">	         2.3 ดอกเบี้ยค้างรับ</xsl:variable>
            ...
            <xsl:variable name="name950085">	         5.2 ดอกเบี้ยค้างรับ</xsl:variable>
            ...
            <xsl:variable name="name950266">	      เงินอุดหนุนจากรัฐบาลหรือส่วนราชการรอการรับรู้เป็นรายได้            </xsl:variable>
            ...
            <xsl:variable name="name950172">	         19.10 ดอกเบี้ยค้างจ่าย</xsl:variable>
            ...
            <xsl:variable name="name950176">	         20.1 ทุนจดทะเบียนที่ออกและชำระแล้ว          </xsl:variable>
            ...
            <xsl:variable name="name950181">	         20.2 ใบสำคัญแสดงสิทธิที่จะซื้อหุ้น</xsl:variable>

            <xsl:variable name="name950182">	         20.3 หัก หุ้นทุนซื้อคืน</xsl:variable>

            <xsl:variable name="name950183">	         20.4 ส่วนเกิน (ต่ำกว่า) มูลค่าหุ้น</xsl:variable>
            ...
            <!--rowUp-->
                ...
                <xsl:variable name="BalanceSheetAmount950027"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950026/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
                ...
                <xsl:variable name="BalanceSheetAmount950039"><xsl:value-of select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950038/BalanceSheetItemInfo/BalanceSheetAmount"/></xsl:variable>
                ...
                <!--4.2-->
                <xsl:variable name="TotalBalanceSheetAmount950049"><xsl:value-of select="$BalanceSheetAmount950073 + $BalanceSheetAmount950074 + $BalanceSheetAmount950075 + $BalanceSheetAmount950076 - $BalanceSheetAmount950077"/></xsl:variable>
                <!--4.3-->
                ...
                <xsl:variable name="TotalBalanceSheetAmount950175"><xsl:value-of select="$TotalBalanceSheetAmount950202 + $BalanceSheetAmount950206 + $BalanceSheetAmount950207 + $BalanceSheetAmount950208 + $BalanceSheetAmount950209 "/></xsl:variable>
            ...
            <body>
                ...
                <table class="displayTable" width="100%" border="1">
                    ...
                    <!--<td colspan="2" class="labelXsl">งบดุล</td>-->
                    <!--</tr>-->
                    <!--<tr>-->
                    <!--<td width="10%" align="center" class="labelXsl"></td>-->
                    <!--<xsl:for-each-->
                    <!--select="DS_BLS/DS_BLS_Content/ContentRecordGroup/BalanceSheetItem950005">-->
                    <!--<td class="paddingSub  labelXsl">-->
                    <!--<xsl:value-of-->
                    <!--select="substring-before(substring-after(@name,')'),'\')"/>-->
                    <!--</td>-->
                    <!--</xsl:for-each>-->
                    <!--<td width="20%" class="labelXsl"></td>-->
                    <!--</tr>-->
                    <tr>
                        ...
                        <xsl:for-each
                            ...
                            <td width="20%" class="labelXsl" align="right">
                                <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                    <span style="color:#1500d4">
                                        <xsl:value-of
                                                select="format-number(BalanceSheetAmount,'###,###,###,###,###,###,###,##0.00')"/>
                                    </span>
                                </xsl:if>
                            </td>
                        </xsl:for-each>
