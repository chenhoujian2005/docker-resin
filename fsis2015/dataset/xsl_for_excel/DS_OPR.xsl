                                ...
                                <tr>
                                    <td width="100%">
                                        ...
                                        <table class="displayTable" width="100%">
                                            ...
                                            <xsl:variable name="ChangeMethodValue" select="DS_OPR/DS_OPR_Content/ContentRecordGroup/ChangeMethodValue"/>
                                            <xsl:variable name="OperationalRisk" select="DS_OPR/DS_OPR_Content/ContentRecordGroup/OperationalRiskMethod"/>
                                            <xsl:variable name="OperationalRiskMethodValue" select="DS_OPR/DS_OPR_Content/ContentRecordGroup/OperationalRiskMethodValue"/>

                                            <xsl:for-each select="DS_OPR/DS_OPR_Content/ContentRecordGroup/DataGroupInfo/DataGroupDetails">
                                                <tr>
