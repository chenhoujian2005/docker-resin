...
<body>
<s:form action="bot_status" validate="false">
                ...
                <tr>
                  <td>
                    <table width="100%">
                      ...
                      <c:if test="${not empty transferBotLogs}">
                      <tr>
                          <%--Edit By Tum 2014--%>
                        <br>
                      ...
                      <tr>
                        <td align="left">
                          <display:table name="transferBotLogs" id="row" export="false" class="displayTag"  style="width:100%;">
                            <%--pagesize="15" requestURI="file_transfer_detail.action"--%>
                            <display:column title="Date" headerClass="headerTable" style="width:15%;text-align:center" format="{0,date,dd MMM yyyy}">
                              <fmt:formatDate value="${row.createDate}" pattern="dd MMM yyyy"/>
                            </display:column>
                            ...
                            <display:column title="Description" headerClass="headerTable" style="width:20%;text-align:left">
                              ${row.description}
                            </display:column>
                            <display:column title="Error Massage" headerClass="headerTable" style="width:53%;text-align:left">
                              ${row.errorMsgString}
                            </display:column>
                          </display:table>
                        </td>
