...
<xsl:stylesheet version="1.0"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="OperationalRiskMethodDescription">OperationalRiskMethodDescription</xsl:variable>
            ...
            <xsl:variable name="OperationalRiskItemDescription">OperationalRiskItemDescription</xsl:variable>
            ...
            <table class="displayTable" width="50%">
                ...
                <table class="displayTable" width="1200px">
                    ...
                    <xsl:for-each select="DS_OPR">
                        <xsl:if test="DS_OPR0 != ''">

                                <xsl:if test="OperationalRiskMethod452001 != ''">
                            <tr>
                                ...
                                <xsl:if test="OperationalRiskMethod452002 != ''">
                                    <tr>
                                    <td class="labelXsl" align="left">
                                ...
                                <xsl:if test="OperationalRiskMethod452003 != ''">
                                    <tr>
                                    <td class="labelXsl" align="left">
                                ...
                                <xsl:if test="OperationalRiskMethod452004 != ''">
                                    <tr>
                                    <td class="labelXsl" align="left">
                                ...
                                <xsl:if test="OperationalRiskMethod452005 != ''">
                                    <tr>
                                    <td class="labelXsl" align="left">
                                ...
                                <xsl:if test="OperationalRiskMethod452006 != ''">
                                    <tr>
                                    <td class="labelXsl" align="left">
                                ...
                                <xsl:if test="OperationalRiskMethod452007 != ''">
                                    <tr>
                                    <td class="labelXsl" align="left">
