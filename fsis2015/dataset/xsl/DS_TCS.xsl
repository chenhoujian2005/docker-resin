    ...
    <xsl:template match="/">
                                ...
                                <tr>
                                        ...
                                        <table class="displayTable" width="1800px">
                                            ...
                                            <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018001,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018001,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                             <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018002,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018002,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            ...
                                            <xsl:if test="ArrangementType = '018003'">
                                                  <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                             <span style="color:#1500d4"><xsl:value-of select="format-number(TotalOutstandingAmount,'###,###,###,##0.00')"/></span>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number(NetOutstandingAmount,'###,###,###,##0.00')"/></span>
                                                        </span>
                                                    </td>
                                                </tr>
                                                </xsl:if>
                                            ...
                                            <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018004,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018004,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                            ...
                                            <tr>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018014,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018014,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                            ...
                                            <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                             ...
                                             <!--<xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">-->
                                                 <!--<xsl:if test="ArrangementType = '018024' or  ArrangementType = '018027'">-->
                                             <tr>
                                                    <td class="labelXsl" align="center">
                                                        018023
                                                    </td>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018023,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018023,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            <!--</xsl:if>-->
                                            ...
                                            <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018024,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018024,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018027,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018027,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                             ...
                                             <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018114,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018114,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <!--<xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">-->
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018006,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018006,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 <!--</xsl:if>-->
                                           ...
                                           <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018032,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018032,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018033,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018033,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018035,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018035,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018037,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018037,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018038,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018038,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018041,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018041,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                             ...
                                             <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018045,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018045,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018046,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018046,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018049,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018049,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <!--<xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">-->
                                                 <!--<xsl:if test="ArrangementType = '018051' or ArrangementType = '018052' or ArrangementType = '018053'">-->
                                                 <tr>
                                                    <td class="labelXsl" align="center">
                                                        018050
                                                    </td>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018050,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018050,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 <!--</xsl:if>-->
                                             ...
                                             <xsl:for-each select="DS_TCS">
                                                <xsl:if test="TotalOutstandingAmount018055 != ''">
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018055,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018055,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                            ...
                                            <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                             ...
                                             <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018280,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018280,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                             ...
                                             <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018080,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018080,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                   ...
                                                   <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018081,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018081,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018087,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018087,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS/DS_TCS_Content/ContentRecordGroup">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/TotalOutstandingAmount018319,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(DS_TCS/NetOutstandingAmount018319,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018305,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018305,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018310,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018310,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                            ...
                                            <xsl:for-each select="DS_TCS">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018316,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018316,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                                 </xsl:if>
                                    ...
                                    <xsl:if test="TotalOutstandingAmount018096 != ''">
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018096,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018096,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
                                        ...
                                        <xsl:if test="TotalOutstandingAmount018099 = ''">
                                                 <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018099,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018099,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                               </xsl:if>
                                        ...
                                        <xsl:if test="TotalOutstandingAmount018100 = ''">
                                            <tr>
                                                    ...
                                                    <td class="labelXsl" align="left">
                                                     ...
                                                     <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018100,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018100,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                             </xsl:if>
                                    ...
                                    <xsl:if test="TotalOutstandingAmount018105 = ''">
                                            <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018105,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018105,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </xsl:if>
		...
		<xsl:if test="TotalOutstandingAmount018108 = ''">
                                            <tr>
                                                    ...
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(TotalOutstandingAmount018108,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                    <td class="labelXsl" align="right">
                                                        <span style="color:#1500d4">
                                                            <xsl:value-of select="format-number(NetOutstandingAmount018108,'###,###,###,##0.00')"/>
                                                        </span>
                                                    </td>
                                                </tr>
                                             </xsl:if>
