...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="name500006">	ยอดหนี้ค้างชำระ 3 เดือน / 6 เดือน	</xsl:variable>
                                                            ...
                                                            <tr>
                                                                <td class="labelXsl" valign="top" align="right">
                                                                    <span style="color:#1500d4">
                                                                        <xsl:value-of select="format-number(GovernmentPolicyProjectItem500001/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td class="labelXsl" valign="top" align="right">
                                                                    <span style="color:#1500d4">
                                                                    <xsl:value-of select="format-number(GovernmentPolicyProjectItem500002/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td class="labelXsl" valign="top" align="right">
                                                                    <span style="color:#1500d4">
                                                                    <xsl:value-of select="format-number(GovernmentPolicyProjectItem500003/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td class="labelXsl" align="right">
                                                                    <span style="color:#1500d4">
                                                                    <xsl:value-of select="format-number(GovernmentPolicyProjectItem500004/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td class="labelXsl" valign="top" align="right">
                                                                    <span style="color:#1500d4">
                                                                    <xsl:value-of select="format-number(GovernmentPolicyProjectItem500005/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td class="labelXsl" valign="top" align="right">
                                                                      <span style="color:#1500d4">
                                                                   <xsl:value-of select="format-number(GovernmentPolicyProjectItem500006/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <td class="labelXsl" valign="top" align="right">
                                                                    <span style="color:#1500d4">
                                                                    <xsl:value-of select="format-number(GovernmentPolicyProjectItem500007/Amount,'###,##0.00')"/>
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            </table>
