...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="name940020">	    2.1.1 มูลค่าเพิ่ม (สุทธิ) จากการตีราคาที่ดิ น                           </xsl:variable>

            <xsl:variable name="name940021">	    2.1.2 มูลค่าเพิ่ม (สุทธิ) จากการตีราคาอาคารและห้องชุดในอา คารชุด                    </xsl:variable>
            ...
            <xsl:variable name="name940024">	  2.4 ส่วนเกินทุน (สุทธิ) จากการตีราคาเงินลงทุนในตราสารทุนประเภทเผื ่อขาย                 </xsl:variable>
            ...
            <xsl:variable name="name940031">	    3.2.1 เงินลงทุนในตราสารที่นับเป็นเงินกองทุนชั้นที่ 2 ของสถาบันการเ งินอื่น                      </xsl:variable>

            <xsl:variable name="name940032">	    3.2.2 ส่วนต่ำกว่าทุน (สุทธิ) จากการตีราคาเงินลงทุนในตราสารทุนประเภทเ ผื่อขาย                     </xsl:variable>
            ...
            <xsl:variable name="TotalAmountPerBook940003"><xsl:value-of select="$AmountPerBook940004 - $AmountPerBook940005 + $AmountPerBook940006"/></xsl:variable>
            ...
            <xsl:variable name="TotalAmountPerBook940014"><xsl:value-of select="$AmountPerBook940015 - $AmountPerBook940016 + $AmountPerBook940017"/></xsl:variable>
            ...
            <xsl:variable name="TotalAmountPerBook940002"><span style="color:#1500d4"><xsl:value-of select="$TotalAmountPerBook940003 + $TotalAmountPerBook940007 + $AmountPerBook940010 + $AmountPerBook940011 + $AmountPerBook940012 + $AmountPerBook940013 - $TotalAmountPerBook940014"/></span></xsl:variable>
           ...
           <xsl:variable name="TotalApplicableCapitalFundAmount940003"><xsl:value-of select="$ApplicableCapitalFundAmount940004 - $ApplicableCapitalFundAmount940005 + $ApplicableCapitalFundAmount940006"/></xsl:variable>
           ...
           <xsl:variable name="TotalApplicableCapitalFundAmount940014"><xsl:value-of select="$ApplicableCapitalFundAmount940015 - $ApplicableCapitalFundAmount940016 + $ApplicableCapitalFundAmount940017"/></xsl:variable>
           ...
           <xsl:variable name="TotalApplicableCapitalFundAmount940002"><span style="color:#1500d4"><xsl:value-of select="$TotalApplicableCapitalFundAmount940003 + $TotalApplicableCapitalFundAmount940007 + $ApplicableCapitalFundAmount940010 + $ApplicableCapitalFundAmount940011 + $ApplicableCapitalFundAmount940012 + $ApplicableCapitalFundAmount940013 - $TotalApplicableCapitalFundAmount940014"/></span></xsl:variable>
             ...
             <xsl:variable name="TotalNetCapitalFundAmount940003"><xsl:value-of select="$NetCapitalFundAmount940004 - $NetCapitalFundAmount940005 + $NetCapitalFundAmount940006"/></xsl:variable>
             ...
             <xsl:variable name="TotalNetCapitalFundAmount940014"><xsl:value-of select="$NetCapitalFundAmount940015 - $NetCapitalFundAmount940016 + $NetCapitalFundAmount940017"/></xsl:variable>
             ...
             <xsl:variable name="TotalNetCapitalFundAmount940002"><span style="color:#1500d4"><xsl:value-of select="$TotalNetCapitalFundAmount940003 + $TotalNetCapitalFundAmount940007 + $NetCapitalFundAmount940010 + $NetCapitalFundAmount940011 + $NetCapitalFundAmount940012 + $NetCapitalFundAmount940013 - $TotalNetCapitalFundAmount940014"/></span></xsl:variable>
            ...
            <xsl:variable name="TotalAmountPerBook940018"><xsl:value-of select="$TotalAmountPerBook940019 + $AmountPerBook940022 + $AmountPerBook940023 + $AmountPerBook940024 + $AmountPerBook940025 + $AmountPerBook940026 + $AmountPerBook940027 "/></xsl:variable>
            <xsl:variable name="TotalApplicableCapitalFundAmount940018"><xsl:value-of select="$TotalApplicableCapitalFundAmount940019 + $ApplicableCapitalFundAmount940022 + $ApplicableCapitalFundAmount940023 + $ApplicableCapitalFundAmount940024 + $ApplicableCapitalFundAmount940025 + $ApplicableCapitalFundAmount940026 + $ApplicableCapitalFundAmount940027 "/></xsl:variable>
            <xsl:variable name="TotalNetCapitalFundAmount940018"><xsl:value-of select="$TotalNetCapitalFundAmount940019 + $NetCapitalFundAmount940022 + $NetCapitalFundAmount940023 + $NetCapitalFundAmount940024 + $NetCapitalFundAmount940025 + $NetCapitalFundAmount940026 + $NetCapitalFundAmount940027 "/></xsl:variable>
            ...
            <xsl:variable name="AmountPerBook940031"><xsl:value-of select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940031/OutstandingAmountPerBook"/></xsl:variable>
            <xsl:variable name="ApplicableCapitalFundAmount940031"><xsl:value-of select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940031/ApplicableCapitalFundAmount"/></xsl:variable>
            <xsl:variable name="NetCapitalFundAmount940031"><xsl:value-of select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940031/NetCapitalFundAmount"/></xsl:variable>

            <xsl:variable name="AmountPerBook940032"><xsl:value-of select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940032/OutstandingAmountPerBook"/></xsl:variable>
            <xsl:variable name="ApplicableCapitalFundAmount940032"><xsl:value-of select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940032/ApplicableCapitalFundAmount"/></xsl:variable>
            <xsl:variable name="NetCapitalFundAmount940032"><xsl:value-of select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940032/NetCapitalFundAmount"/></xsl:variable>
            ...
            <xsl:variable name="TotalAmountPerBook940030"><xsl:value-of select="$AmountPerBook940031 + $AmountPerBook940032 + $AmountPerBook940033"/></xsl:variable>
            <xsl:variable name="TotalApplicableCapitalFundAmount940030"><xsl:value-of select="$ApplicableCapitalFundAmount940031 + $ApplicableCapitalFundAmount940032 + $ApplicableCapitalFundAmount940033"/></xsl:variable>
            <xsl:variable name="TotalNetCapitalFundAmount940030"><xsl:value-of select="$NetCapitalFundAmount940031 + $NetCapitalFundAmount940032 + $NetCapitalFundAmount940033"/></xsl:variable>
            ...
            <xsl:variable name="TotalAmountPerBook940034"><xsl:value-of select="$AmountPerBook940035 + $AmountPerBook940036"/></xsl:variable>
            <xsl:variable name="TotalApplicableCapitalFundAmount940034"><xsl:value-of select="$ApplicableCapitalFundAmount940035 + $ApplicableCapitalFundAmount940036"/></xsl:variable>
            <xsl:variable name="TotalNetCapitalFundAmount940034"><xsl:value-of select="$NetCapitalFundAmount940035 + $NetCapitalFundAmount940036"/></xsl:variable>
            <head>
                                           ...
                                           <table class="displayTable" width="100%">
                                               ...
                                               <table class="displayTable" width="100%" >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="60%" class="labelXsl"><xsl:value-of select="$name940002"/></td>
                                                       ...
                                                       <tr>
                                                                ...
                                                                <td class="paddingSub  labelXsl"><xsl:value-of select="$var940003"/></td>
                                                                <td class="labelXsl" align="right">
                                                           ...
                                                           <tr>
                                                               ...
                                                               <td class="subOne  labelXsl"><xsl:value-of select="$name940004"/></td>
                                                                <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940004">
                                                                 <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number(OutstandingAmountPerBook,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number(ApplicableCapitalFundAmount,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number(NetCapitalFundAmount,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                               </xsl:for-each>
                                                           </tr>
                                                        <tr>
                                                            <td class="labelXsl" align="center">940005</td>
                                                            <td class="subOne  labelXsl"><xsl:value-of select="$name940005"/></td>
                                                        ...
                                                        <tr>
                                                             ...
                                                             <td class="paddingSub  labelXsl"><xsl:value-of select="$name940006"/></td>
                                                        ...
                                                        <tr>
                                                             <td class="labelXsl" align="center">940007</td>
                                                                <td class="paddingSub  labelXsl"><xsl:value-of select="$name940007"/></td>
                                                                <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940007">
                                                                </xsl:for-each><!--<td class="labelXsl"><xsl:value-of select="substring(@name,25,60)"/></td>-->
                                                               <td class="labelXsl" align="right">
                                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalAmountPerBook940007,'###,###,###,###,###,###,##0.00')"/></span>
                                                                </td>
                                                                <td class="labelXsl" align="right">
                                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalApplicableCapitalFundAmount940007,'###,###,###,###,###,###,##0.00')"/></span>
                                                                </td>
                                                                <td class="labelXsl" align="right">
                                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalNetCapitalFundAmount940007,'###,###,###,###,###,###,##0.00')"/></span>
                                                                    </td>

                                                           </tr>
                                                        <tr>
                                                              <td class="labelXsl" align="center">940008</td>
                                                             <td class="subOne  labelXsl"><xsl:value-of select="$name940008"/></td>
                                                       ...
                                                       <tr>
                                                             ...
                                                             <td class="subOne  labelXsl"><xsl:value-of select="$name940009"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940010"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940011"/></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="paddingSub  labelXsl"><xsl:value-of select="$name940012"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940013"/></td>
                                                        ...
                                                        <tr>
                                                              <td class="labelXsl" align="center">940014</td>
                                                               <td class="labelXsl paddingSub"><xsl:value-of select="$name940014"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="subOne  labelXsl"><xsl:value-of select="$name940015"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="subOne  labelXsl"><xsl:value-of select="$name940016"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="subOne  labelXsl"><xsl:value-of select="$name940017"/></td>
                                                       ...
                                                       <tr>
                                                              <td class="labelXsl" align="center">940018</td>
                                                                <td class="labelXsl"><xsl:value-of select="$name940018"/></td>
                                                        ...
                                                        <tr>
                                                              <td class="labelXsl" align="center">940019</td>
                                                                <td class="paddingSub labelXsl"><xsl:value-of select="$name940019"/></td>
                                                                <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940020">
                                                       ...
                                                       <tr>
                                                              ...
                                                              <td class="subOne  labelXsl"><xsl:value-of select="$name940020"/></td>
                                                                <xsl:for-each select="DS_CAP/DS_CAP_Content/ContentRecordGroup/CapitalFundItem940020">
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="subOne  labelXsl"><xsl:value-of select="$name940021"/></td>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td class="paddingSub  labelXsl"><xsl:value-of select="$name940022"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940023"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940024"/></td>
                                                       ...
                                                       <tr>
                                                                ...
                                                                <td class="paddingSub  labelXsl"><xsl:value-of select="$name940025"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940026"/></td>
                                                       ...
                                                       <tr>
                                                                ...
                                                                <td class="paddingSub  labelXsl"><xsl:value-of select="$name940027"/></td>
                                                       ...
                                                       <tr>
                                                                ...
                                                                <td class="labelXsl"><xsl:value-of select="$name940028"/></td>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td class="paddingSub  labelXsl"><xsl:value-of select="$name940029"/></td>
                                                       ...
                                                       <tr>
                                                              <td class="labelXsl" align="center">940030</td>
                                                                <td class="paddingSub  labelXsl"><xsl:value-of select="$name940030"/></td>
                                                        ...
                                                        <tr>
                                                              <td class="labelXsl" align="center">940031</td>
                                                               <td class="subOne labelXsl"><xsl:value-of select="$name940031"/></td>
                                                              <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number($AmountPerBook940031,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number($ApplicableCapitalFundAmount940031,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number($NetCapitalFundAmount940031,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                           </tr>
                                                       <tr>
                                                              <td class="labelXsl" align="center">940032</td>
                                                              <td class="subOne labelXsl"><xsl:value-of select="$name940032"/></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number($AmountPerBook940032,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number($ApplicableCapitalFundAmount940032,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                                <td class="labelXsl" align="right"><span style="color:#1500d4"><xsl:value-of select="format-number($NetCapitalFundAmount940032,'###,###,###,###,###,###,##0.00')"/></span></td>
                                                           </tr>
                                                        <tr>
                                                              <td class="labelXsl" align="center">940033</td>
                                                            <td class="subOne labelXsl"><xsl:value-of select="$name940033"/></td>
                                                        ...
                                                        <tr>
                                                              <td class="labelXsl" align="center">940034</td>
                                                                <td class="labelXsl"><xsl:value-of select="$name940034"/></td>
                                                       ...
                                                       <tr>
                                                              <td class="labelXsl" align="center">940035</td>
                                                                <td class="paddingSub  labelXsl"><xsl:value-of select="$name940035"/></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="paddingSub  labelXsl"><xsl:value-of select="$name940036"/></td>
