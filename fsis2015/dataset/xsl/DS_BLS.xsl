...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <html>
            ...
            <xsl:variable name="name950267">	         ทุนประเดิม / เงินทุนรับโอนจากรัฐบาล [เฉพาะ SFI]          </xsl:variable>
            ...
            <!--rowUp-->
                ...
                <!--950134-->
                <xsl:variable name="TotalBalanceSheetAmount950134"><xsl:value-of select="$TotalBalanceSheetAmount950263 + $TotalBalanceSheetAmount950175"/></xsl:variable>
                <!--950002 สินทรัพย์ -->
                <xsl:variable name="TotalBalanceSheetAmount950002"><xsl:value-of select="$TotalBalanceSheetAmount950003 + $TotalBalanceSheetAmount950008 + $BalanceSheetAmount950018 + $TotalBalanceSheetAmount950019 + $TotalBalanceSheetAmount950081 + $TotalBalanceSheetAmount950091 + $BalanceSheetAmount950098 + $BalanceSheetAmount950099 + $TotalBalanceSheetAmount950100 + $TotalBalanceSheetAmount950118"/></xsl:variable>
            <!--</xsl:for-each>-->
            <!--rowUp-->
                                        ...
                                        <table class="displayTable" width="100%" border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950002,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950003,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                     <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950004,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl" width="10%">950005</td>
                                                    ...
                                                    <td width="10%" align="right" class="labelXsl">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950005,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950006</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"> <xsl:value-of select="format-number($BalanceSheetAmount950006,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950007</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950007,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="subOne  labelXsl">
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                           <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950008,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="subTwo  labelXsl">
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950009,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950010</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                         <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950010,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950011</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950011,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950012,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950013</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950013,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950014</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950014,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950015</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950015,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950016</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950016,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950017</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950017,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950018</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950018,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                     <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950019,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950020,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950021,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950022</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950022,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950023</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950023,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950024</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950024,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950025,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950026</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950026,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950027</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950027,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                     <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950028,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950029</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950029,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950030</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950030,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950031</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950031,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950032,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950033</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950033,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950034</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950034,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950035</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950035,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950036,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950037</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950037,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950038</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950038,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950039</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950039,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950040</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950040,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950041</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950041,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950042</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950042,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950043,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950044</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950044,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950045</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950045,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950046</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950046,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950047</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950047,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950048</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950048,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950049,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950050,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950051,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" class="labelXsl">950052</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950052,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950053</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950053,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950054</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950054,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950055,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950056</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950056,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950057</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950057,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950058</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950058,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950059</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950059,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950060</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950060,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950061,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950062</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950062,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950063</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950063,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950064</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950064,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950065,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950066</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950066,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950067</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950067,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950068</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950068,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950069</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950069,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950070</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950070,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950071</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950071,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950072,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950073</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950073,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950074</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950074,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950075</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950075,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950076</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950076,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950077</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950077,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950078,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950079</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950079,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950080</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950080,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950081,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950082,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="labelXsl">950083</td>
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950083,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                    </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950084,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950085,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950086,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950087,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950088,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950089,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950090,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                             <span style="color:#1500d4"><xsl:value-of select="format-number(BalanceSheetAmount,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950091,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950092,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950093,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950094,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950095,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950096,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950097,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950098,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950099,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950100,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950101,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950102,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950103,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950104,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950105,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950106,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950107,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950108,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950109,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950110,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950111,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950112,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950113,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950114,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950115,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950116,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950117,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                               ...
                                               <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950118,'###,###,###,###,###,###,###,##0.00')"/></span>
                                               </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950119,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950120,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950121,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950122,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950123,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950124,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950125,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950126,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950127,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950128,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950129,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950130,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950131,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950132,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950133,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950134,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                     <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950263,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950135,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950136,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950137,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950138,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950139,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950140,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950141,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950142,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950143,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950144,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950145,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950146,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950147,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950148,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950149,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950150,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950151,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950152,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950153,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950154,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950155,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950156,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950157,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950158,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950159,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950160,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950161,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950265,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950266,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950162,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950163,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950164,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950165,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950166,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950167,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950168,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950169,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950170,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950171,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950172,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950173,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950174,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950175,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                     <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950176,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                             <tr>
                                               ...
                                               <td width="20%" class="labelXsl" align="right">
                                                   <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950177,'###,###,###,###,###,###,###,##0.00')"/></span>
                                               </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950178,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950179,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950180,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950181,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950182,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950183,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950184,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950185,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950186,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950187,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950188,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950189,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950190,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950191,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950192,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950193,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950194,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950195,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950196,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950197,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950198,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950199,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950200,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950201,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950202,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950203,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950204,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950205,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950206,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950207,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950208,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950209,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950210,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950267,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950268,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950269,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950233,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950234,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950235,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950236,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950237,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950238,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950239,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950241,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                     <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950242,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950243,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950244,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950245,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950246,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950247,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950248,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950249,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950250,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950252,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950253,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950254,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950255,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950256,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950257,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950258,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950259,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="20%" class="labelXsl" align="right">
                                                    <span style="color:#1500d4"><xsl:value-of select="format-number($TotalBalanceSheetAmount950260,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950261,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
                                            <tr>
                                                ...
                                                <xsl:for-each
                                                    ...
                                                    <td width="20%" class="labelXsl" align="right">
                                                        <xsl:if test="not (BalanceSheetAmount=' 'or BalanceSheetAmount='')">
                                                            <span style="color:#1500d4"><xsl:value-of select="format-number($BalanceSheetAmount950262,'###,###,###,###,###,###,###,##0.00')"/></span>
                                                        </xsl:if>
                                                    </td>
                                                </xsl:for-each>
                                            </tr>
