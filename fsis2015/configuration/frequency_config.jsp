...
<body>
<s:form action="frequency_config">
<s:hidden name="id"/>
                        ...
                        <table width="100%" border="0" align="center" style="height:100%">
                            <tr>
                                <td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <c:if test="${sessionScope.menuAuthentication.frequencyManage}">
                                                   ...
                                                   <%--<s:submit action="frequency_config_detail" id="btnNew" value="Add Frequency" cssClass="button" cssStyle="width:150px"/>--%>
                                                </c:if>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <%--<c:if test="${sfiRightList ne null}">--%>
                                    ...
                                    <br>
                                    <display:table name="mainList" id="row" export="false" class="displayTag" style="width:100%" pagesize="20" requestURI="frequency_config.action">
                                        <display:column title="SFIs Name"  headerClass="headerTable"  style="text-align:left;width:40%" sortable="true">

                                        <a href="frequency_config_detail_view.action?id=${row.id}">${row.sfi.nameTh}</a>
                                        </display:column>
                                        ...
                                        <c:if test="${sessionScope.menuAuthentication.frequencyManage}">
                                            <display:column title="Copy" headerClass="headerTable" style="text-align:center;width:9%">
                                                <img src="../images/copy-icon.png" border="no" align="" onclick="letsGo2('frequency_config_detail.action?copy=true','${row.id}')" style="cursor:pointer">
                                            </display:column>
                                            <display:column title="Edit" headerClass="headerTable" style="text-align:center;width:9%">
                                                <img src="../images/edit.gif" border="no" align="" onclick="letsGo('frequency_config_detail.action','${row.id}')" style="cursor:pointer">
                                            </display:column>
