...
<script type="text/javascript">
    function validateForm(){
        ...
        if(thisForm.upload.value == '' && '${requestScope.originalFileName}' == ''){
...
<body>
<s:form action="help_detail" enctype="multipart/form-data">
                                ...
                                <td style="height:100%">
                                    ...
                                    <table width="100%" class="displayTable">
                                        <tr class="bgGreen2">
                                            ...
                                            <td width="80%">
                                                <s:textfield name="title" id="title" size="50" maxLength="256"/>
                                            </td>
                                        </tr>
                                        <tr class="bgGreen1">
                                            <td  class="label">
                                            ...
                                            <td>
                                                <%--<s:textarea name="description" id="description" size="50" maxLength="50"/>--%>
                                                <s:textarea rows="3" cols="48" maxlength="1024"
                                                            name="description"
                                                            id="description"> </s:textarea>
                                            </td>
                                        </tr>
                                        <tr class="bgGreen2">
                                            <td class="label">
                                            ...
                                            <td>
                                                <s:file size="50" name="upload" id="upload"/>
                                                <a href="../downloadFile.sl?fileName=${requestScope.uploadFileName}&originalFileName=${requestScope.originalFileName}&systemName=<%=Constants.Fsis2010UploadDirectory.HELP%>" title="Download attachment file">${requestScope.originalFileName}</a>
                                        ...
                                        <tr class="bgGreen1">
                                            ...
                                            <td>
                                                <s:textfield name="actionDate" readonly="true" size="8"/>
