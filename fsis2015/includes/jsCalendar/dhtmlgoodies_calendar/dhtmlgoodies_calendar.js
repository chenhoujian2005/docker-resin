...
function showMonthDropDown()
{
	if(document.getElementById('monthDropDown').style.display=='block'){
        ...
        document.getElementById('monthDropDown').style.left = 80;
...
function showYearDropDown()
{
    ...
    if(document.getElementById('yearDropDown').style.display=='block'){
        ...
        document.getElementById('yearDropDown').style.left = 150;
		document.getElementById('monthDropDown').style.display='none';
		document.getElementById('hourDropDown').style.display='none';
		document.getElementById('minuteDropDown').style.display='none';
		if (MSIE)
...
function highlightClear(){
 if(this.src.indexOf('over')>=0){
		this.src = pathToImages + 'clear.jpg';
	}else{
		this.src = pathToImages + 'clear-over.jpg';
	}
}
...
function writeTopBar(){
    ...
    clearDiv.style.marginRight = '1px';
    var img = document.createElement('IMG');
    img.src = pathToImages + 'clear.jpg';
	img.onmouseover = highlightClear;
    img.onmouseout = highlightClear;
    img.onclick = clearCalrndar;
	clearDiv.appendChild(img);
	topBar.appendChild(clearDiv);
	if(Opera)clearDiv.style.width = '16px';
...
function setTimeProperties()
{
	if(!calendarDisplayTime){
        ...
        document.getElementById('timeBar').style.width = '80px';
